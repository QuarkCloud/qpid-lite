...
#include "qpid/driver/TCPConnector.h"
...
namespace {
    Connector* create(sys::Poller::shared_ptr p, framing::ProtocolVersion v, const amqp::ConnectionOptions& s, ConnectionImpl* c) 
	{
...
TCPConnector::TCPConnector(Poller::shared_ptr p,
                     ProtocolVersion ver,
                     const amqp::ConnectionOptions& settings,
