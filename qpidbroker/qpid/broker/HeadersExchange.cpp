...
#include "qpid/base/amqp/MapHandler.h"
...
using std::string;
using qpid::base::amqp::MapHandler;
...
class Matcher : public MapHandler
{
  public:
    ...
    void handleBool(const qpid::base::amqp::CharSequence& key, bool value) { processUint(std::string(key.data, key.size), value); }
    void handleUint8(const qpid::base::amqp::CharSequence& key, uint8_t value) { processUint(std::string(key.data, key.size), value); }
    void handleUint16(const qpid::base::amqp::CharSequence& key, uint16_t value) { processUint(std::string(key.data, key.size), value); }
    void handleUint32(const qpid::base::amqp::CharSequence& key, uint32_t value) { processUint(std::string(key.data, key.size), value); }
    void handleUint64(const qpid::base::amqp::CharSequence& key, uint64_t value) { processUint(std::string(key.data, key.size), value); }
    void handleInt8(const qpid::base::amqp::CharSequence& key, int8_t value) { processInt(std::string(key.data, key.size), value); }
    void handleInt16(const qpid::base::amqp::CharSequence& key, int16_t value) { processInt(std::string(key.data, key.size), value); }
    void handleInt32(const qpid::base::amqp::CharSequence& key, int32_t value) { processInt(std::string(key.data, key.size), value); }
    void handleInt64(const qpid::base::amqp::CharSequence& key, int64_t value) { processInt(std::string(key.data, key.size), value); }
    void handleFloat(const qpid::base::amqp::CharSequence& key, float value) { processFloat(std::string(key.data, key.size), value); }
    void handleDouble(const qpid::base::amqp::CharSequence& key, double value) { processFloat(std::string(key.data, key.size), value); }
    void handleString(const qpid::base::amqp::CharSequence& key, const qpid::base::amqp::CharSequence& value, const qpid::base::amqp::CharSequence& /*encoding*/)
    {
        processString(std::string(key.data, key.size), std::string(value.data, value.size));
    }
    void handleVoid(const qpid::base::amqp::CharSequence& key)
    {
