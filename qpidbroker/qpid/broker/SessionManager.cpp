...
std::auto_ptr<SessionState>  SessionManager::attach(SessionHandler& h, const base::SessionId& id, bool force) 
{
...
void SessionManager::forget(const base::SessionId& id) {
    Mutex::ScopedLock l(lock);
    attached.erase(id);
}
