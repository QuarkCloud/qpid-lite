 ...
 */
class FrameInspector : public base::ConnectionOutputHandler
{
public:
...
Connection::Connection(base::ConnectionOutputHandler* out_,
...
void Connection::recordFromServer(const framing::AMQFrame& frame)
{
    if (mgmtObject != 0)
    {
        qpid::broker::manage::Connection::PerThreadStats *cStats = mgmtObject->getStatistics();
