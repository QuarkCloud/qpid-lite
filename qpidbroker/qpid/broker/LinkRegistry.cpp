...
class LinkRegistryConnectionObserver : public ConnectionObserver {
  ...
  public:
    ...
    {
        amqp0_10::Connection* c = dynamic_cast<amqp0_10::Connection*>(&in);
...
void LinkRegistry::notifyConnection(const std::string& key, amqp0_10::Connection* c)
{
