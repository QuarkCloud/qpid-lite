...
{
    message = intrusive_ptr<qpid::broker::amqp0_10::MessageTransfer>(new qpid::broker::amqp0_10::MessageTransfer(id));
    state = METHOD;
}
...
boost::intrusive_ptr<qpid::broker::amqp0_10::MessageTransfer> MessageBuilder::getMessage() { return message; }
