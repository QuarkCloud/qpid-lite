...
namespace qpid {
	namespace broker {
		...
		ManagementDirectExchange::ManagementDirectExchange(const std::string& _name, ::qmf2::Manageable* _parent, Broker* b) :
		...
		ManagementDirectExchange::ManagementDirectExchange(const std::string& _name,
			bool               _durable,
			const framing::FieldTable&  _args,
			::qmf2::Manageable*        _parent, Broker* b) :
