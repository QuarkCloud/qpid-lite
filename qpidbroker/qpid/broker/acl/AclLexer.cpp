	...
	namespace broker {
		namespace acl {
			...
			ObjectType AclHelper::getObjectType(const std::string& str) {
				...
				throw qpid::sys::Exception("Acl illegal object name: " + str);
			}
			...
			Action AclHelper::getAction(const std::string& str) {
				...
				throw qpid::sys::Exception("Acl illegal action name: " + str);
			}
			...
			Property AclHelper::getProperty(const std::string& str) {
				...
				throw qpid::sys::Exception("Acl illegal property name: " + str);
			}
			...
			SpecProperty AclHelper::getSpecProperty(const std::string& str) {
				...
				throw qpid::sys::Exception("Acl illegal spec property name: " + str);
			}
			...
			AclResult AclHelper::getAclResult(const std::string& str) {
				...
				throw qpid::sys::Exception("Acl illegal result name: " + str);
			}
