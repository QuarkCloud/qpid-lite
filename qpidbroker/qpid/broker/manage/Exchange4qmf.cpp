...
uint8_t Exchange::md5Sum[MD5_LEN]   =
    {0xb6,0xe4,0x44,0x4e,0x2d,0xdd,0xc6,0x72,0xda,0x22,0x86,0xef,0x5c,0x88,0xf0,0xeb};

Exchange::Exchange (ManagementAgent*, Manageable* _core, ::qmf2::Manageable* _parent, const std::string& _name) :
...
void Exchange::debugStats (const std::string& comment)
{
