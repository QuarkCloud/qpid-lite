...
string  Outgoing::packageName  = string ("org.apache.qpid.broker");
string  Outgoing::className    = string ("outgoing");
uint8_t Outgoing::md5Sum[MD5_LEN]   =
    {0x20,0xb,0x9d,0x57,0x14,0x9e,0xc3,0x4,0xcd,0x53,0x54,0x1,0x83,0xca,0x5f,0x39};

Outgoing::Outgoing (ManagementAgent*, Manageable* _core, ::qmf2::Manageable* _parent, const std::string& _containerid, const std::string& _name, const std::string& _source, const std::string& _target, const std::string& _domain) :
...
void Outgoing::debugStats (const std::string& comment)
{
...
void Outgoing::registerSelf(ManagementAgent* agent)
{
    agent->registerClass(packageName, className, md5Sum, writeSchema);
}

void Outgoing::writeSchema (std::string& schema)
{
...
void Outgoing::aggregatePerThreadStats(struct PerThreadStats* totals) const
{
    totals->transfers = 0;
...
uint32_t Outgoing::writePropertiesSize() const
{
...
void Outgoing::readProperties (const std::string& _sBuf)
{
...
void Outgoing::writeProperties (std::string& _sBuf) const
{
    const int _bufSize=65536;
    char _msgChars[_bufSize];
    ::qmf2::Buffer buf(_msgChars, _bufSize);
...
void Outgoing::writeStatistics (std::string& _sBuf, bool skipHeaders)
{
    const int _bufSize=65536;
    char _msgChars[_bufSize];
    ::qmf2::Buffer buf(_msgChars, _bufSize);
...
void Outgoing::doMethod (string&, const string&, string& outStr, const string&)
{
...
std::string Outgoing::getKey() const
{
...
void Outgoing::mapEncodeValues (::qpid::types::Variant::Map& _map,
...
void Outgoing::mapDecodeValues (const ::qpid::types::Variant::Map& _map)
{
...
void Outgoing::doMethod (string&, const ::qpid::types::Variant::Map&, ::qpid::types::Variant::Map& outMap, const string&)
{
    Manageable::status_t status = Manageable::STATUS_UNKNOWN_METHOD;
    std::string          text;
