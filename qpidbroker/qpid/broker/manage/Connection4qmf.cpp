...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			Connection::Connection(ManagementAgent*, Manageable* _core, ::qmf2::Manageable* _parent, const std::string& _address, bool _incoming, bool _SystemConnection, const std::string& _protocol) :
			...
			uint32_t Connection::writePropertiesSize() const
			{
				...
				size += 2;  // saslSsf
				size += :: qpid::broker::amqp0_10::MapCodec::encodedSize(remoteProperties);  // remoteProperties
