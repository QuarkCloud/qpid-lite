...
Subscription::Subscription (ManagementAgent*, Manageable* _core, ::qmf2::Manageable* _parent, const ::qmf2::ObjectId& _queueRef, const std::string& _name, bool _browsing, bool _acknowledged, bool _exclusive, const ::qpid::types::Variant::Map& _arguments) :
...
void Subscription::debugStats (const std::string& comment)
{
