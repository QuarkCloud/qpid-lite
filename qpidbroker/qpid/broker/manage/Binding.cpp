...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			Binding::Binding(ManagementAgent*, Manageable* _core, ::qmf2::Manageable* _parent, const ::qmf2::ObjectId& _queueRef, const std::string& _bindingKey, const ::qpid::types::Variant::Map& _arguments) :
			...
			void Binding::debugStats(const std::string& comment)
			{
