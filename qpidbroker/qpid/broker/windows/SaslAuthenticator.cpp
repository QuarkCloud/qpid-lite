...
namespace qpid {
	namespace broker {
		...
		{
			qpid::broker::amqp0_10::Connection& connection;
			framing::AMQP_ClientProxy::Connection client;
			string realm;
		public:
			NullAuthenticator(qpid::broker::amqp0_10::Connection& connection);
			~NullAuthenticator();
		...
		public:
			SspiAuthenticator(qpid::broker::amqp0_10::Connection& connection);
			~SspiAuthenticator();
			void getMechanisms(framing::Array& mechanisms);
			void start(const std::string& mechanism, const std::string* response);
		...
		std::auto_ptr<SaslAuthenticator> SaslAuthenticator::createAuthenticator(qpid::broker::amqp0_10::Connection& c)
		{
		...
		NullAuthenticator::NullAuthenticator(qpid::broker::amqp0_10::Connection& c) :
		...
		SspiAuthenticator::SspiAuthenticator(qpid::broker::amqp0_10::Connection& c) : userToken(INVALID_HANDLE_VALUE), connection(c), client(c.getOutput())
		{
		}
