#ifndef QPID_BROKER_MANAGEMENT_AGENT_H
#define QPID_BROKER_MANAGEMENT_AGENT_H 1
...
#include "qpid/broker/manage/MemStat.h"
	...
	namespace broker {
		...
		public:
			...
			QPID_BROKER_EXTERN void registerEvent(const std::string& packageName,
				...
				uint8_t*    md5Sum,
				::qmf2::ManagementObject::writeSchemaCall_t schemaCall);
			QPID_BROKER_EXTERN::qmf2::ObjectId addObject(::qmf2::ManagementObject::shared_ptr object,
				uint64_t                     persistId = 0,
				bool                         persistent = false);
			QPID_BROKER_EXTERN::qmf2::ObjectId addObject(::qmf2::ManagementObject::shared_ptr object,
				const std::string&           key,
				bool                         persistent = false);
			QPID_BROKER_EXTERN void raiseEvent(const ::qmf2::ManagementEvent& event,
			...
			public:
				...
				DeletedObject(::qmf2::ManagementObject::shared_ptr, bool v1, bool v2);
				~DeletedObject() {};
			...
			private:
				friend class ::qpid::broker::ManagementAgent;
		...
		private:
			...
			//
			struct RemoteAgent : public ::qmf2::Manageable
			{
				...
				::qpid::broker::manage::Agent::shared_ptr mgmtObject;
				RemoteAgent(ManagementAgent& _agent) : agent(_agent) {}
				::qmf2::ManagementObject::shared_ptr GetManagementObject(void) const { return mgmtObject; }
			...
			typedef std::map<::qmf2::ObjectId, boost::shared_ptr<RemoteAgent> > RemoteAgentMap;
			...
			{
				uint8_t  kind;
				::qmf2::ManagementObject::writeSchemaCall_t writeSchemaCall;
				std::string data;
				uint32_t pendingSequence;

				SchemaClass(uint8_t _kind = 0, uint32_t seq = 0) :
					kind(_kind), writeSchemaCall(0), pendingSequence(seq) {}
				SchemaClass(uint8_t _kind, ::qmf2::ManagementObject::writeSchemaCall_t call) :
			...
			//
			::qmf2::ManagementObjectMap          managementObjects;

			//
			// Protected by addLock
			//
			::qmf2::ManagementObjectVector       newManagementObjects;
			...
			//
			qpid::broker::manage::Memory::shared_ptr memstat;

			void writeData();
			void periodicProcessing(void);
			void deleteObjectNow(const ::qmf2::ObjectId& oid);
			...
			void handleAttachRequest(framing::Buffer& inBuffer, const std::string& replyToKey, uint32_t sequence, const ::qmf2::ObjectId& objectId);
			...
			::qmf2::ManagementObjectMap::iterator numericFind(const ::qmf2::ObjectId& oid);
...
#endif  /*!QPID_BROKER_MANAGEMENT_AGENT_H*/
