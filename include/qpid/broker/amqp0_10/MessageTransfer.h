#ifndef QPID_BROKER_AMQP0_10_MESSAGE_TRANSFER_H
#define QPID_BROKER_AMQP0_10_MESSAGE_TRANSFER_H 1
...
class MessageTransfer : public qpid::broker::Message::SharedStateImpl, public qpid::broker::PersistableMessage
{
  public:
    ...
    qpid::base::amqp::MessageId getMessageId() const;
    qpid::base::amqp::MessageId getCorrelationId() const;
...
#endif  /*!QPID_BROKER_AMQP0_10_MESSAGE_TRANSFER_H*/
