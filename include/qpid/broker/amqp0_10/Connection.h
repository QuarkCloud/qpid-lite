#ifndef QPID_BROKER_AMQP0_10_CONNECTION_H
#define QPID_BROKER_AMQP0_10_CONNECTION_H 1
...
class Connection : public base::ConnectionInputHandler, public qpid::broker::Connection,
                   ...
                   public sys::RefCounted
{
  public:
    ...
    const ::qmf2::ObjectId getObjectId() const { return GetManagementObject()->getObjectId(); };
    ...
    std::vector<sys::Url>& getKnownHosts() { return knownHosts; }
    ...
    base::ConnectionOutputHandler& getOutput() { return *out; }
    void activateOutput();
    void addOutputTask(OutputTask*);
    void removeOutputTask(OutputTask*);
    framing::ProtocolVersion getVersion() const { return version; }

    Connection(base::ConnectionOutputHandler* out,
               Broker& broker,
    ...
    ::qpid::broker::ManagementAgent* getAgent() const { return agent; }
  ...
  private:
    ...
    qpid::broker::manage::Connection::shared_ptr mgmtObject;

    //contained output tasks
    sys::AggregateOutput outputTasks;

    boost::scoped_ptr<framing::FrameHandler> outboundTracker;
    boost::scoped_ptr<base::ConnectionOutputHandler> out;
...
friend class OutboundFrameTracker;
  ...
  public:
    ...
    qpid::broker::manage::Connection::shared_ptr getMgmtObject() { return mgmtObject; }
};
}
...
#endif  /*!QPID_BROKER_AMQP0_10_CONNECTION_H*/
