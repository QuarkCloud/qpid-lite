                        ...
                        public qmf2::Manageable
{
    ...
    int deliveryCount;
    qpid::broker::manage::Subscription::shared_ptr mgmtObject;
    ...
    QPID_BROKER_EXTERN qmf2::ManagementObject::shared_ptr
    GetManagementObject(void) const;

    QPID_BROKER_EXTERN qmf2::Manageable::status_t
    ManagementMethod(uint32_t methodId, qmf2::Args& args, std::string& text);
};
