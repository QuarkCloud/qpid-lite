#ifndef QPID_BROKER_SESSION_OUTPUT_EXCEPTION_H
#define QPID_BROKER_SESSION_OUTPUT_EXCEPTION_H 1
 ...
 * context).
 */
struct SessionOutputException : qpid::framing::SessionException
{
    const uint16_t channel;
    SessionOutputException(const qpid::framing::SessionException& e, uint16_t c) : 
		qpid::framing::SessionException(e.code, e.getMessage()), channel(c) {}
};
}} // namespace qpid::broker

#endif  /*!QPID_BROKER_SESSION_OUTPUT_EXCEPTION_H*/
