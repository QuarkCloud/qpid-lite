#ifndef QPID_BROKER_EXCHANGE_H
#define QPID_BROKER_EXCHANGE_H 1
...
namespace qpid {
	namespace broker {
		...
		class QPID_BROKER_CLASS_EXTERN Exchange : public PersistableExchange, public ::qmf2::Manageable {
		public:
			struct Binding : public ::qmf2::Manageable {
				...
				std::string               origin;
				::qpid::broker::manage::Binding::shared_ptr mgmtBinding;
				...
				::qmf2::ManagementObject::shared_ptr GetManagementObject() const;
			};
		...
		protected:
			...
			*/
			...
			::qpid::broker::manage::Exchange::shared_ptr mgmtExchange;
			::qpid::broker::manage::Broker::shared_ptr brokerMgmtObject;

		public:
			typedef boost::shared_ptr<Exchange> shared_ptr;

			QPID_BROKER_EXTERN explicit Exchange(const std::string& name, ::qmf2::Manageable* parent = 0,
				Broker* broker = 0);
			QPID_BROKER_EXTERN Exchange(const std::string& _name, bool _durable, bool autodelete, const qpid::framing::FieldTable& _args,
				::qmf2::Manageable* parent = 0, Broker* broker = 0);
			...
			QPID_BROKER_EXTERN ::qmf2::ManagementObject::shared_ptr GetManagementObject(void) const;
