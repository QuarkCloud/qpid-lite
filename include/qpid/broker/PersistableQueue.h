#ifndef QPID_BROKER_PERSISTABLE_QUEUE_H
#define QPID_BROKER_PERSISTABLE_QUEUE_H 1
...
class ExternalQueueStore : public ::qmf2::Manageable
{
public:
...
#endif /** QPID_BROKER_PERSISTABLE_QUEUE_H*/
