#ifndef QPID_BROKER_ACL_TOPIC_MATCH_H
#define QPID_BROKER_ACL_TOPIC_MATCH_H 1
...
namespace qpid {
	namespace broker {
		...
		class qpid::broker::TopicExchange::TopicExchangeTester {
...
#endif // QPID_BROKER_ACL_TOPIC_MATCH_H
