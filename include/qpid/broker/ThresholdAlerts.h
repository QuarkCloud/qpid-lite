#ifndef QPID_BROKER_THRESHOLD_ALERTS_H
#define QPID_BROKER_THRESHOLD_ALERTS_H 1
...
class ThresholdAlerts : public QueueObserver
{
  public:
    ...
    static void observe(Queue& queue, ::qpid::broker::ManagementAgent& agent,
...
#endif  /*!QPID_BROKER_THRESHOLD_ALERTS_H*/
