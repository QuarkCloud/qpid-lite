#ifndef QPID_BROKER_LINK_REGISTRY_H
#define QPID_BROKER_LINK_REGISTRY_H 1
...
namespace qpid {
	namespace broker {
		...
		class LinkRegistry {
			...
			void notifyConnection(const std::string& key, amqp0_10::Connection* c);
		...
		public:
			 ...
			 */
			void setParent(qmf2::Manageable* _parent) { parent = _parent; }
...
#endif  /*!QPID_BROKER_LINK_REGISTRY_H*/
