...
struct NoSuchTransportException : qpid::sys::Exception
{
    NoSuchTransportException(const std::string& s) : qpid::sys::Exception(s) {}
 ...
 * A broker instance.
 */
class Broker : public sys::Runnable, public base::Plugin::Target,
               public qmf2::Manageable,
	public sys::RefCounted
{
    ...
    qpid::broker::manage::Broker::shared_ptr mgmtObject;
    Vhost::shared_ptr            vhostObject;
    System::shared_ptr           systemObject;
    QueueCleaner queueCleaner;
    std::vector<sys::Url> knownBrokers;
    std::vector<sys::Url> getKnownBrokersImpl();
  ...
  public:
    ...
    const base::DataDir& getDataDir() { return dataDir; }
    const base::DataDir& getPagingDir() { return pagingDir; }
    ...
    QPID_BROKER_EXTERN qmf2::ManagementObject::shared_ptr GetManagementObject() const;
    QPID_BROKER_EXTERN qmf2::Manageable* GetVhostObject() const;
    QPID_BROKER_EXTERN qmf2::Manageable::status_t ManagementMethod(
        uint32_t methodId, qmf2::Args& args, std::string& text);
    ...
    */
    ...
    boost::function<std::vector<sys::Url> ()> getKnownBrokers;

    static QPID_BROKER_EXTERN const std::string TCP_TRANSPORT;

    ManagementAgent* getManagementAgent() { return managementAgent.get(); }
