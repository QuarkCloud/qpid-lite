 ...
 *
 */
#ifndef QPID_BROKER_MANAGEMENT_DIRECT_EXCHANGE_H
#define QPID_BROKER_MANAGEMENT_DIRECT_EXCHANGE_H 1
...
class ManagementDirectExchange : public virtual DirectExchange
{
  ...
  public:
    ...
    ManagementDirectExchange(const std::string& name, ::qmf2::Manageable* _parent = 0, Broker* broker = 0);
...
#endif /** QPID_BROKER_MANAGEMENT_DIRECT_EXCHANGE_H */
