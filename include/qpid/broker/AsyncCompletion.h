#ifndef QPID_BROKER_ASYNC_COMPLETION_H
#define QPID_BROKER_ASYNC_COMPLETION_H 1
...
class AsyncCompletion : public virtual sys::RefCounted
{
 public:
     ...
     */
    class Callback : public sys::RefCounted
    {
      public:
        // Normally sys::RefCounted objects cannot be copied.
        // Allow Callback objects to be copied (by subclasses implementing clone())
        // The copy has an initial refcount of 0
        Callback(const Callback&) : sys::RefCounted() {}
        Callback() {}
...
#endif  /*!QPID_BROKER_ASYNC_COMPLETION_H*/
