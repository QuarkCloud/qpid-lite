...
namespace qpid {
	namespace broker {
		...
		public:
			...
			virtual boost::intrusive_ptr<const qpid::broker::amqp0_10::MessageTransfer> translate(const Message&) = 0;
		...
		public:
			...
			QPID_BROKER_EXTERN boost::intrusive_ptr<const qpid::broker::amqp0_10::MessageTransfer> translate(const Message&);
