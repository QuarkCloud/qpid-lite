...
class Queue : public boost::enable_shared_from_this<Queue>,
	public PersistableQueue, public ::qmf2::Manageable {
  public:
  ...
  friend struct AutoDeleteTask;
	...
	qpid::broker::manage::Queue::shared_ptr mgmtObject;
  ...
  public:
    ...
    QPID_BROKER_EXTERN ManagementMethod (uint32_t methodId, qmf2::Args& args, std::string& text);
