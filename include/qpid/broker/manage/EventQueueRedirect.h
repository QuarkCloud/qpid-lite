...
#ifndef QPID_BROKER_MANAGE_EVENT_QUEUE_REDIRECT_H
#define QPID_BROKER_MANAGE_EVENT_QUEUE_REDIRECT_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventQueueRedirect : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventQueueRedirect(const std::string& _qName,
					const std::string& _qTarget);
				QPID_BROKER_EXTERN ~EventQueueRedirect() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_QUEUE_REDIRECT_H*/
