...
#ifndef QPID_BROKER_MANAGE_EVENT_DENY_H
#define QPID_BROKER_MANAGE_EVENT_DENY_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventDeny : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventDeny(const std::string& _userId,
					const std::string& _action,
					const std::string& _objectType,
					const std::string& _objectName,
					const ::qpid::types::Variant::Map& _arguments);
				QPID_BROKER_EXTERN ~EventDeny() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_DENY_H*/
