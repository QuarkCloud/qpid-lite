...
#ifndef QPID_BROKER_MANAGE_BRIDGE_H
#define QPID_BROKER_MANAGE_BRIDGE_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class Bridge : public ::qmf2::ManagementObject
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN Bridge(
					...
					::qmf2::Manageable* coreObject, ::qmf2::Manageable* _parent, const std::string& _name, bool _durable, const std::string& _src, const std::string& _dest, const std::string& _key, bool _srcIsQueue, bool _srcIsLocal, const std::string& _tag, const std::string& _excludes, bool _dynamic, uint16_t _sync, uint32_t _credit);
...
#endif  /*!QPID_BROKER_MANAGE_BRIDGE_H*/
