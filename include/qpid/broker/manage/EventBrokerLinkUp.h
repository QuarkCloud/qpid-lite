...
#ifndef QPID_BROKER_MANAGE_EVENT_BROKER_LINK_UP_H
#define QPID_BROKER_MANAGE_EVENT_BROKER_LINK_UP_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventBrokerLinkUp : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventBrokerLinkUp(const std::string& _rhost);
				QPID_BROKER_EXTERN ~EventBrokerLinkUp() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_BROKER_LINK_UP_H*/
