...
#ifndef QPID_BROKER_MANAGE_BROKER_H
#define QPID_BROKER_MANAGE_BROKER_H 1
...
namespace qpid {
	namespace broker {
		...
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class Broker : public ::qmf2::ManagementObject
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN static const uint32_t METHOD_GETLOGHIRESTIMESTAMP = 11;
				QPID_BROKER_EXTERN static const uint32_t METHOD_SETLOGHIRESTIMESTAMP = 12;
				QPID_BROKER_EXTERN static const uint32_t METHOD_QUEUEREDIRECT = 13;
				QPID_BROKER_EXTERN static const uint32_t METHOD_SHUTDOWN = 14;

				// Accessor Methods
				inline void set_systemRef(const ::qmf2::ObjectId& val) {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					systemRef = val;
					configChanged = true;
				}
				inline const ::qmf2::ObjectId& get_systemRef() {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					return systemRef;
				}
...
#endif  /*!QPID_BROKER_MANAGE_BROKER_H*/
