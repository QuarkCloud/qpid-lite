...
#ifndef QPID_BROKER_MANAGE_EVENT_UNBIND_H
#define QPID_BROKER_MANAGE_EVENT_UNBIND_H 1 
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventUnbind : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventUnbind(const std::string& _rhost,
					const std::string& _user,
					const std::string& _exName,
					const std::string& _qName,
					const std::string& _key);
				QPID_BROKER_EXTERN ~EventUnbind() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_UNBIND_H*/
