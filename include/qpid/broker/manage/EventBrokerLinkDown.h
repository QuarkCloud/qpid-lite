...
#ifndef QPID_BROKER_MANAGE_EVENT_BROKER_LINK_DOWN_H
#define QPID_BROKER_MANAGE_EVENT_BROKER_LINK_DOWN_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventBrokerLinkDown : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventBrokerLinkDown(const std::string& _rhost);
				QPID_BROKER_EXTERN ~EventBrokerLinkDown() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_BROKER_LINK_DOWN_H*/
