...
#ifndef QPID_BROKER_MANAGE_EVENT_QUEUE_THRESHOLD_CROSSED_DOWNWARD_H
#define QPID_BROKER_MANAGE_EVENT_QUEUE_THRESHOLD_CROSSED_DOWNWARD_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventQueueThresholdCrossedDownward : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventQueueThresholdCrossedDownward(const std::string& _qName,
					const uint64_t _msgDepth,
					const uint64_t _byteDepth);
				QPID_BROKER_EXTERN ~EventQueueThresholdCrossedDownward() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_QUEUE_THRESHOLD_CROSSED_DOWNWARD_H*/
