...
#ifndef QPID_BROKER_MANAG_EVENT_CONNECTION_DENY_H
#define QPID_BROKER_MANAG_EVENT_CONNECTION_DENY_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventConnectionDeny : public ::qmf2::ManagementEvent
			{
			private:
...
#endif  /*!QPID_BROKER_MANAG_EVENT_CONNECTION_DENY_H*/
