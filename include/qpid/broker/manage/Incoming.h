...
#ifndef QPID_BROKER_MANAGE_INCOMING_H
#define QPID_BROKER_MANAGE_INCOMING_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class Incoming : public ::qmf2::ManagementObject
			{
			private:
...
#endif  /*!QPID_BROKER_MANAGE_INCOMING_H*/
