...
#ifndef QPID_BROKER_MANAGE_EVENT_ALLOW_H
#define QPID_BROKER_MANAGE_EVENT_ALLOW_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventAllow : public ::qmf2::ManagementEvent
			{
			private:
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_ALLOW_H*/
