...
#ifndef QPID_BROKER_MANAGE_EVENT_CLIENT_CONNECT_FAIL_H
#define QPID_BROKER_MANAGE_EVENT_CLIENT_CONNECT_FAIL_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventClientConnectFail : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventClientConnectFail(const std::string& _rhost,
					const std::string& _user,
					const std::string& _reason,
					const ::qpid::types::Variant::Map& _properties);
				QPID_BROKER_EXTERN ~EventClientConnectFail() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_CLIENT_CONNECT_FAIL_H*/
