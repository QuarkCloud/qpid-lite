...
#ifndef QPID_BROKER_MANAGE_QUEUE_POLICY_H
#define QPID_BROKER_MANAGE_QUEUE_POLICY_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class QueuePolicy : public ::qmf2::ManagementObject
			{
			private:
			...
			public:
				...
				typedef boost::shared_ptr<QueuePolicy> shared_ptr;
				...
				QPID_BROKER_EXTERN QueuePolicy(
...
#endif  /*!QPID_BROKER_MANAGE_QUEUE_POLICY_H*/
