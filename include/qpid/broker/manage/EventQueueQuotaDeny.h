...
#ifndef QPID_BROKER_MANAGE_EVENT_QUEUE_QUOTA_DENY_H
#define QPID_BROKER_MANAGE_EVENT_QUEUE_QUOTA_DENY_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventQueueQuotaDeny : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventQueueQuotaDeny(const std::string& _userId,
					const std::string& _queueName);
				QPID_BROKER_EXTERN ~EventQueueQuotaDeny() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_QUEUE_QUOTA_DENY_H*/
