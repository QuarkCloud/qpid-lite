...
#ifndef QPID_BROKER_MANAGE_EVENT_FILE_LOADED_H
#define QPID_BROKER_MANAGE_EVENT_FILE_LOADED_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventFileLoaded : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventFileLoaded(const std::string& _userId);
				QPID_BROKER_EXTERN ~EventFileLoaded() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_FILE_LOADED_H*/
