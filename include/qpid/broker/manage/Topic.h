...
#ifndef QPID_BROKER_MANAGE_TOPIC_H
#define QPID_BROKER_MANAGE_TOPIC_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class Topic : public ::qmf2::ManagementObject
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN Topic(
					...
					::qmf2::Manageable* coreObject, const std::string& _name, const ::qmf2::ObjectId& _exchangeRef, bool _durable);
...
#endif  /*!QPID_BROKER_MANAGE_TOPIC_H*/
