...
#ifndef QPID_BROKER_MANAGE_EVENT_FILE_LOAD_FAILED_H
#define QPID_BROKER_MANAGE_EVENT_FILE_LOAD_FAILED_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventFileLoadFailed : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventFileLoadFailed(const std::string& _userId,
					const std::string& _reason);
				QPID_BROKER_EXTERN ~EventFileLoadFailed() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_FILE_LOAD_FAILED_H*/
