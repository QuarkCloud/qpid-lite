...
#ifndef QPID_BROKER_MANAGE_LINK_H
#define QPID_BROKER_MANAGE_LINK_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class Link : public ::qmf2::ManagementObject
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN Link(
					...
					::qmf2::Manageable* coreObject, ::qmf2::Manageable* _parent, const std::string& _name, bool _durable);
...
#endif  /*!QPID_BROKER_MANAGE_LINK_H*/
