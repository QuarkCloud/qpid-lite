...
#ifndef QPID_BROKER_MANAGE_EXCHANGE_H
#define QPID_BROKER_MANAGE_EXCHANGE_H 1
...
QPID_BROKER_CLASS_EXTERN class Exchange : public ::qmf2::ManagementObject
{
  private:
...
#endif  /*!QPID_BROKER_MANAGE_EXCHANGE_H*/
