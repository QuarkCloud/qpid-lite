...
#ifndef QPID_BROKER_MANAGE_EVENT_CLIENT_CONNECT_H
#define QPID_BROKER_MANAGE_EVENT_CLIENT_CONNECT_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventClientConnect : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventClientConnect(const std::string& _rhost,
					const std::string& _user,
					const ::qpid::types::Variant::Map& _properties);
				QPID_BROKER_EXTERN ~EventClientConnect() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_CLIENT_CONNECT_H*/
