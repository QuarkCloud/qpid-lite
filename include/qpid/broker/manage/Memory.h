...
#ifndef QPID_BROKER_MANAGE_MEMORY_H
#define QPID_BROKER_MANAGE_MEMORY_H 1
...
namespace qpid {
	namespace broker {
		...
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class Memory : public ::qmf2::ManagementObject
			{
			private:
			...
			public:
				...
				typedef boost::shared_ptr<Memory> shared_ptr;
...
#endif  /*!QPID_BROKER_MANAGE_MEMORY_H*/
