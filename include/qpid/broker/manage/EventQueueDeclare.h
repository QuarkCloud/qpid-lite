...
#ifndef QPID_BROKER_MANAGE_EVENT_QUEUE_DECLARE_H
#define QPID_BROKER_MANAGE_EVENT_QUEUE_DECLARE_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventQueueDeclare : public ::qmf2::ManagementEvent
			{
			private:
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_QUEUE_DECLARE_H*/
