...
#ifndef QPID_BROKER_MANAGE_EVENT_UNSUBSCRIBE_H
#define QPID_BROKER_MANAGE_EVENT_UNSUBSCRIBE_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventUnsubscribe : public ::qmf2::ManagementEvent
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN EventUnsubscribe(const std::string& _rhost,
					const std::string& _user,
					const std::string& _dest);
				QPID_BROKER_EXTERN ~EventUnsubscribe() {};
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_UNSUBSCRIBE_H*/
