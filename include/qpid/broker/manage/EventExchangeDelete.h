...
#ifndef QPID_BROKER_MANAGE_EXCHANGE_DELETE_H
#define QPID_BROKER_MANAGE_EXCHANGE_DELETE_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventExchangeDelete : public ::qmf2::ManagementEvent
			{
			private:
...
#endif  /*!QPID_BROKER_MANAGE_EXCHANGE_DELETE_H*/
