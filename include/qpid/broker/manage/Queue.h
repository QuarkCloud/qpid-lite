...
#ifndef QPID_BROKER_MANAGE_QUEUE_H
#define QPID_BROKER_MANAGE_QUEUE_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class Queue : public ::qmf2::ManagementObject
			{
			private:
			...
			public:
				...
				QPID_BROKER_EXTERN Queue(
					...
					::qmf2::Manageable* coreObject, ::qmf2::Manageable* _parent, const std::string& _name, bool _durable, bool _autoDelete);
				...
				// Accessor Methods
				inline void set_exclusive(bool val) {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					exclusive = val;
					configChanged = true;
				}
				inline bool get_exclusive() {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					return exclusive;
				}
				...
				inline void set_altExchange(const ::qmf2::ObjectId& val) {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					altExchange = val;
					presenceMask[presenceByte_altExchange] |= presenceMask_altExchange;
					configChanged = true;
				}
				inline const ::qmf2::ObjectId& get_altExchange() {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					return altExchange;
				}
				...
				inline void inc_msgFtdDepth(uint64_t by = 1) {
					getThreadStats()->msgFtdDepth += by;
					instChanged = true;
				}
				inline void dec_msgFtdDepth(uint64_t by = 1) {
					getThreadStats()->msgFtdDepth -= by;
					instChanged = true;
				}
				inline void inc_byteFtdDepth(uint64_t by = 1) {
					getThreadStats()->byteFtdDepth += by;
					instChanged = true;
				}
				inline void dec_byteFtdDepth(uint64_t by = 1) {
					getThreadStats()->byteFtdDepth -= by;
					instChanged = true;
				}
				...
				inline void set_redirectPeer(const std::string& val) {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					redirectPeer = val;
					instChanged = true;
				}
				inline const std::string& get_redirectPeer() {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					return redirectPeer;
				}
				inline void set_redirectSource(bool val) {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					redirectSource = val;
					instChanged = true;
				}
				inline bool get_redirectSource() {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					return redirectSource;
				}
				inline void set_creator(const std::string& val) {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					creator = val;
					instChanged = true;
				}
				inline const std::string& get_creator() {
					::qmf2::Mutex::ScopedLock mutex(accessLock);
					return creator;
				}
...
#endif  /*!QPID_BROKER_MANAGE_QUEUE_H*/
