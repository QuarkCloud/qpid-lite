...
#ifndef QPID_BROKER_MANAGE_MANAGEMENT_SETUP_STATE_H
#define QPID_BROKER_MANAGE_MANAGEMENT_SETUP_STATE_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class ManagementSetupState : public ::qmf2::ManagementObject
			{
			private:
...
#endif  /*!QPID_BROKER_MANAGE_MANAGEMENT_SETUP_STATE_H*/
