...
#ifndef QPID_BROKER_MANAGE_EVENT_SUBSCRIBE_H
#define QPID_BROKER_MANAGE_EVENT_SUBSCRIBE_H 1
...
namespace qpid {
	namespace broker {
		namespace manage {
			...
			QPID_BROKER_CLASS_EXTERN class EventSubscribe : public ::qmf2::ManagementEvent
			{
			private:
...
#endif  /*!QPID_BROKER_MANAGE_EVENT_SUBSCRIBE_H*/
