#ifndef QPID_BROKER_MESSAGE_H
#define QPID_BROKER_MESSAGE_H 1
	...
	namespace broker {
		...
		public:
			...
			public:
				...
				virtual qpid::base::amqp::MessageId getMessageId() const = 0;
				virtual qpid::base::amqp::MessageId getCorrelationId() const = 0;
				...
				virtual void processProperties(qpid::base::amqp::MapHandler&) const = 0;
			...
			void processProperties(qpid::base::amqp::MapHandler&) const;
