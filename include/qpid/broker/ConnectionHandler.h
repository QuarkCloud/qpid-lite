 ...
 *
 */
#ifndef QPID_BROKER_CONNECTION_HANDLER_H
#define QPID_BROKER_CONNECTION_HANDLER_H 1
	...
	namespace broker {
		...
		class ConnectionHandler : public framing::FrameHandler
		{
			struct Handler : public framing::AMQP_AllOperations::ConnectionHandler
			{
				...
				Handler(amqp0_10::Connection& connection, bool isClient);
				~Handler();
		...
		public:
			ConnectionHandler(amqp0_10::Connection& connection, bool isClient);
			void heartbeat();
			void handle(framing::AMQFrame& frame);
			void setSecureConnection(SecureConnection* secured);
			bool isOpen() { return handler->isOpen; }
			friend class amqp0_10::Connection;
		};
	}
}

#endif /**QPID_BROKER_CONNECTION_HANDLER_H*/
