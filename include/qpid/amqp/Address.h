#ifndef QPID_AMQP_ADDRESS_H
#define QPID_AMQP_ADDRESS_H 1
 ...
 */
class QPID_AMQP_CLASS_EXTERN Address
{
  public:
    QPID_AMQP_EXTERN Address();
    QPID_AMQP_EXTERN Address(const std::string& address);
    QPID_AMQP_EXTERN Address(const std::string& name, const std::string& subject,
                               const qpid::types::Variant::Map& options, const std::string& type = "");
    QPID_AMQP_EXTERN Address(const Address& address);
    QPID_AMQP_EXTERN ~Address();
    QPID_AMQP_EXTERN Address& operator=(const Address&);
    QPID_AMQP_EXTERN const std::string& getName() const;
    QPID_AMQP_EXTERN void setName(const std::string&);
    QPID_AMQP_EXTERN const std::string& getSubject() const;
    QPID_AMQP_EXTERN void setSubject(const std::string&);
    QPID_AMQP_EXTERN const qpid::types::Variant::Map& getOptions() const;
    QPID_AMQP_EXTERN qpid::types::Variant::Map& getOptions();
    QPID_AMQP_EXTERN void setOptions(const qpid::types::Variant::Map&);

    QPID_AMQP_EXTERN std::string getType() const;
    /**
     ...
     * needed.
     */
    QPID_AMQP_EXTERN void setType(const std::string&);

    QPID_AMQP_EXTERN std::string str() const;
    QPID_AMQP_EXTERN operator bool() const;
    QPID_AMQP_EXTERN bool operator !() const;

	QPID_AMQP_EXTERN static void setTemporary(Address& a, bool value);// { a.impl->temporary = value; }
	QPID_AMQP_EXTERN static bool isTemporary(const Address& a); // { return a.impl->temporary; }
...
#ifndef SWIG
QPID_AMQP_EXTERN std::ostream& operator<<(std::ostream& out, const Address& address);
#endif

}} // namespace qpid::amqp

#endif  /*!QPID_AMQP_ADDRESS_H*/
