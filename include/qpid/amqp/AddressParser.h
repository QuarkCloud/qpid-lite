#ifndef QPID_AMQP_ADDRESS_PARSER_H
#define QPID_AMQP_ADDRESS_PARSER_H 1
...
namespace qpid {
	namespace amqp {
		...
		{
		public:
			QPID_AMQP_EXTERN AddressParser(const std::string&);
			bool parse(Address& address);
			QPID_AMQP_EXTERN bool parseMap(qpid::types::Variant::Map& map);
			QPID_AMQP_EXTERN bool parseList(qpid::types::Variant::List& list);
		private:
...
#endif  /*!QPID_AMQP_ADDRESS_PARSER_H*/
