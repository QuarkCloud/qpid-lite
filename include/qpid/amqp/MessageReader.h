#ifndef QPID_AMQP_MESSAGE_READER_H
#define QPID_AMQP_MESSAGE_READER_H 1
...
namespace qpid {
	namespace amqp {
		...
		{
		public:
			QPID_AMQP_EXTERN MessageReader();

			//header, properties, amqp-sequence, amqp-value
			QPID_AMQP_EXTERN bool onStartList(uint32_t, const CharSequence&, const CharSequence&, const Descriptor*);
			QPID_AMQP_EXTERN void onEndList(uint32_t, const Descriptor*);

			//delivery-annotations, message-annotations, application-headers, amqp-value
			QPID_AMQP_EXTERN bool onStartMap(uint32_t, const CharSequence&, const CharSequence&, const Descriptor*);
			QPID_AMQP_EXTERN void onEndMap(uint32_t, const Descriptor*);
			...
			QPID_AMQP_EXTERN bool onStartArray(uint32_t, const CharSequence&, const Constructor&, const Descriptor*);
			QPID_AMQP_EXTERN void onEndArray(uint32_t, const Descriptor*);
			QPID_AMQP_EXTERN void onDescriptor(const Descriptor&, const char*);
			...
			QPID_AMQP_EXTERN CharSequence getBareMessage() const;
...
#endif  /*!QPID_AMQP_MESSAGE_READER_H*/
