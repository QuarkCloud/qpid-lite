#ifndef QPID_AMQP_MESSAGE_H
#define QPID_AMQP_MESSAGE_H 1
...
namespace qpid {
	namespace amqp {
		 ...
		 */
		class QPID_AMQP_CLASS_EXTERN Message
		{
		public:
			QPID_AMQP_EXTERN Message(qpid::types::Variant&);
			QPID_AMQP_EXTERN Message(const std::string& bytes = std::string());
			QPID_AMQP_EXTERN Message(const char*, size_t);
			QPID_AMQP_EXTERN Message(const Message&);
			QPID_AMQP_EXTERN ~Message();

			QPID_AMQP_EXTERN Message& operator=(const Message&);

			QPID_AMQP_EXTERN void setReplyTo(const Address&);
			QPID_AMQP_EXTERN const Address& getReplyTo() const;

			QPID_AMQP_EXTERN void setSubject(const std::string&);
			 ...
			 */
			QPID_AMQP_EXTERN void setContentType(const std::string&);
			/**
			 ...
			 */
			QPID_AMQP_EXTERN void setMessageId(const std::string&);
			 ...
			 */
			QPID_AMQP_EXTERN void setUserId(const std::string&);
			 ...
			 */
			QPID_AMQP_EXTERN void setCorrelationId(const std::string&);
			 ...
			 * priority messages.
			 */
			QPID_AMQP_EXTERN void setPriority(uint8_t);
			 ...
			 */
			QPID_AMQP_EXTERN void setTtl(MilliDuration ttl);
			/**
			 *Get the time to live for this message in milliseconds.
			 */
			QPID_AMQP_EXTERN MilliDuration getTtl() const;
			 ...
			 * it to be lost.
			 */
			QPID_AMQP_EXTERN void setDurable(bool durable);
			QPID_AMQP_EXTERN bool getDurable() const;
			 ...
			 * duplicate.
			 */
			QPID_AMQP_EXTERN bool getRedelivered() const;
			/**
			 ...
			 */
			QPID_AMQP_EXTERN void setRedelivered(bool);
			 ...
			 */
			QPID_AMQP_EXTERN const qpid::types::Variant::Map& getProperties() const;
			QPID_AMQP_EXTERN qpid::types::Variant::Map& getProperties();
			QPID_AMQP_EXTERN void setProperties(const qpid::types::Variant::Map&);
			 ...
			 */
			QPID_AMQP_EXTERN void setContent(const std::string&);
			/**
			 * Copy count bytes from the region pointed to by chars as the
			 * message content.
			 */
			QPID_AMQP_EXTERN void setContent(const char* chars, size_t count);

			/** Get the content as a std::string */
			QPID_AMQP_EXTERN std::string getContent() const;
			/** Get the content as raw bytes (an alias for getContent() */
			QPID_AMQP_EXTERN std::string getContentBytes() const;
			/** Set the content as raw bytes (an alias for setContent() */
			QPID_AMQP_EXTERN void setContentBytes(const std::string&);
			/**
			 ...
			 */
			QPID_AMQP_EXTERN qpid::types::Variant& getContentObject();
			/**
			 * Get the content as a Variant, which can represent an object of
			 * different types. This can be used for content representing a
			 * map or a list for example.
			 */
			QPID_AMQP_EXTERN const qpid::types::Variant& getContentObject() const;
			/**
			 * Set the content using a Variant, which can represent an object
			 * of different types.
			 */
			QPID_AMQP_EXTERN void setContentObject(const qpid::types::Variant&);
			/**
			 ...
			 */
			QPID_AMQP_EXTERN const char* getContentPtr() const;
			/** Get the size of content in bytes. */
			QPID_AMQP_EXTERN size_t getContentSize() const;

			QPID_AMQP_EXTERN void setProperty(const std::string&, const qpid::types::Variant&);
		private:
			MessageImpl* impl;
			friend struct MessageImplAccess;
		};

		struct QPID_AMQP_CLASS_EXTERN EncodingException : qpid::types::Exception
		{
			QPID_AMQP_EXTERN EncodingException(const std::string& msg);
		};
		 ...
		 */
		QPID_AMQP_EXTERN void decode(const Message& message,
		 ...
		 * @exception EncodingException
		 */
		QPID_AMQP_EXTERN void encode(const qpid::types::Variant::Map& map,
			Message& message,
			const std::string& encoding = std::string());
		/**
		 ...
		 * @exception EncodingException
		 */
		QPID_AMQP_EXTERN void encode(const qpid::types::Variant::List& list,
			Message& message,
			const std::string& encoding = std::string());
