#ifndef QPID_AMQP_MAP_READER_H
#define QPID_AMQP_MAP_READER_H 1
...
namespace qpid {
	namespace amqp {
		...
		public:
			...
			QPID_AMQP_EXTERN MapReader();
			QPID_AMQP_EXTERN static const int SYMBOL_KEY;
			QPID_AMQP_EXTERN static const int STRING_KEY;
			QPID_AMQP_EXTERN void setAllowedKeyType(int);
		private:
			CharSequence key;
			size_t level;
			int keyType;
