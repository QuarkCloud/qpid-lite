#ifndef QPID_BASE_AMQP_MAP_READER_H
#define QPID_BASE_AMQP_MAP_READER_H 1
	...
	namespace base {
		namespace amqp {
			...
			public:
				...
				QPID_BASE_EXTERN MapReader();
				QPID_BASE_EXTERN static const int SYMBOL_KEY;
				QPID_BASE_EXTERN static const int STRING_KEY;
				QPID_BASE_EXTERN void setAllowedKeyType(int);
			private:
				CharSequence key;
				size_t level;
				int keyType;
...
#endif  /*!QPID_BASE_AMQP_MAP_READER_H*/
