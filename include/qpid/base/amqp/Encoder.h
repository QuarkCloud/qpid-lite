#ifndef QPID_BASE_AMQP_ENCODER_H
#define QPID_BASE_AMQP_ENCODER_H 1
...
#include "qpid/base/amqp/Constructor.h"
	...
	namespace base {
		namespace amqp {
			...
			public:
				 ...
				 */
				QPID_BASE_EXTERN Encoder(char* data, size_t size);
				...
				QPID_BASE_EXTERN void writeBinary(const std::string&, const Descriptor* d = 0);
				...
				QPID_BASE_EXTERN void writeValue(const qpid::types::Variant&, const Descriptor* d = 0);
				QPID_BASE_EXTERN void writeMap(const std::map<std::string, qpid::types::Variant>& value, const Descriptor* d = 0, bool large = true);
				QPID_BASE_EXTERN void writeList(const std::list<qpid::types::Variant>& value, const Descriptor* d = 0, bool large = true);

				void writeDescriptor(const Descriptor&);
				QPID_BASE_EXTERN size_t getPosition();
...
#endif  /*!QPID_BASE_AMQP_ENCODER_H*/
