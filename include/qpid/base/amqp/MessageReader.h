#ifndef QPID_BASE_AMQP_MESSAGE_READER_H
#define QPID_BASE_AMQP_MESSAGE_READER_H 1
...
namespace qpid {
	namespace base {
		namespace amqp {
			...
			{
			public:
				QPID_BASE_EXTERN MessageReader();

				//header, properties, amqp-sequence, amqp-value
				QPID_BASE_EXTERN bool onStartList(uint32_t, const CharSequence&, const CharSequence&, const Descriptor*);
				QPID_BASE_EXTERN void onEndList(uint32_t, const Descriptor*);

				//delivery-annotations, message-annotations, application-headers, amqp-value
				QPID_BASE_EXTERN bool onStartMap(uint32_t, const CharSequence&, const CharSequence&, const Descriptor*);
				QPID_BASE_EXTERN void onEndMap(uint32_t, const Descriptor*);
				...
				QPID_BASE_EXTERN bool onStartArray(uint32_t, const CharSequence&, const Constructor&, const Descriptor*);
				QPID_BASE_EXTERN void onEndArray(uint32_t, const Descriptor*);
				QPID_BASE_EXTERN void onDescriptor(const Descriptor&, const char*);
				...
				QPID_BASE_EXTERN CharSequence getBareMessage() const;
...
#endif  /*!QPID_BASE_AMQP_MESSAGE_READER_H*/
