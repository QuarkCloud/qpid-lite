#ifndef QPID_BASE_AMQP_MESSAGE_ENCODER_H
#define QPID_BASE_AMQP_MESSAGE_ENCODER_H 1
		...
		namespace amqp {
			...
			public:
				...
				public:
					...
					QPID_BASE_EXTERN virtual bool hasTtl() const = 0;
				...
				QPID_BASE_EXTERN MessageEncoder(char* d, size_t s) : Encoder(d, s), optimise(true) {}
				QPID_BASE_EXTERN void writeHeader(const Header&);
				QPID_BASE_EXTERN void writeProperties(const Properties&);
				QPID_BASE_EXTERN void writeApplicationProperties(const ApplicationProperties&);
				QPID_BASE_EXTERN void writeApplicationProperties(const qpid::types::Variant::Map& properties);
				QPID_BASE_EXTERN void writeApplicationProperties(const qpid::types::Variant::Map& properties, bool useLargeMap);

				QPID_BASE_EXTERN static size_t getEncodedSize(const Header&);
				QPID_BASE_EXTERN static size_t getEncodedSize(const Properties&);
				QPID_BASE_EXTERN static size_t getEncodedSize(const ApplicationProperties&);

				QPID_BASE_EXTERN static size_t getEncodedSize(const qpid::types::Variant::List&, bool useLargeList);
				QPID_BASE_EXTERN static size_t getEncodedSize(const qpid::types::Variant::Map&, bool useLargeMap);

				QPID_BASE_EXTERN static size_t getEncodedSizeForValue(const qpid::types::Variant& value);
				QPID_BASE_EXTERN static size_t getEncodedSizeForContent(const std::string&);

				//used in translating 0-10 content to 1.0, to determine buffer space needed
				QPID_BASE_EXTERN static size_t getEncodedSize(const Properties&, const qpid::types::Variant::Map&, const std::string&);
...
#endif  /*!QPID_BASE_AMQP_MESSAGE_ENCODER_H*/
