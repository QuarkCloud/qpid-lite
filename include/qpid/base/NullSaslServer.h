#ifndef QPID_BASE_NULL_SASL_SERVER_H
#define QPID_BASE_NULL_SASL_SERVER_H 1
...
namespace qpid {
	namespace base {
		...
		{
		public:
			QPID_BASE_EXTERN NullSaslServer(const std::string& realm);
...
#endif  /*!QPID_BASE_NULL_SASL_SERVER_H*/
