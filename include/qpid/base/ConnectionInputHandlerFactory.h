 ...
 *
 */
#ifndef QPID_BASE_CONNECTION_INPUT_HANDLER_FACTORY_H
#define QPID_BASE_CONNECTION_INPUT_HANDLER_FACTORY_H 1
...
#endif /** QPID_BASE_CONNECTION_INPUT_HANDLER_FACTORY_H*/
