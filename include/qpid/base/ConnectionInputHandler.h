 ...
 *
 */
#ifndef QPID_BASE_CONNECTION_INPUT_HANDLER_H
#define QPID_BASE_CONNECTION_INPUT_HANDLER_H 1
...
#endif /** QPID_BASE_CONNECTION_INPUT_HANDLER_H */
