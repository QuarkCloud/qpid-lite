#ifndef QPID_SYS_LOCK_FILE_H
#define QPID_SYS_LOCK_FILE_H 1
...
public:
    QPID_SYS_EXTERN LockFile(const std::string& path_, bool create);
	QPID_SYS_EXTERN ~LockFile();
};
 
}}   /* namespace qpid::sys */

#endif /*!QPID_SYS_LOCK_FILE_H*/
