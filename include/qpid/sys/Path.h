 ...
 */
class QPID_SYS_CLASS_EXTERN Path {

    std::string path;

  public:
    // Path separator, forward or backslash
    static const QPID_SYS_EXTERN std::string separator;
	...
	QPID_SYS_EXTERN bool exists() const;
	QPID_SYS_EXTERN bool isFile() const;
	QPID_SYS_EXTERN bool isDirectory() const;
	QPID_SYS_EXTERN bool isAbsolute() const;
