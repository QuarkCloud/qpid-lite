#ifndef QPID_SYS_TRANSPORT_FACTORY_H
#define QPID_SYS_TRANSPORT_FACTORY_H 1
...
#include "qpid/sys/SharedObject.h"
...
class TransportAcceptor : public qpid::sys::SharedObject<TransportAcceptor>
{
  public:
...
class TransportConnector : public qpid::sys::SharedObject<TransportConnector>
{
public:
...
#endif /** QPID_SYS_TRANSPORT_FACTORY_H*/
