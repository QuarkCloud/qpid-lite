#ifndef QPID_SYS_ASYNCHIO_H
#define QPID_SYS_ASYNCHIO_H 1
/*
 *
...
public:
    ...
    QPID_SYS_EXTERN static AsynchAcceptor* create(const Socket& s, Callback callback);
...
public:
	...
	QPID_SYS_EXTERN static AsynchConnector* create(const Socket& s,
...
public:
    ...
    // deletes. To correctly manage heaps when needed, the allocate and
    // delete should both be done from the same class/library.
	QPID_SYS_EXTERN static AsynchIO* create(const Socket& s,
                            ReadCallback rCb,
                            EofCallback eofCb,
