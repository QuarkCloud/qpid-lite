#ifndef QPID_SYS_SYSTEM_INFO_H
#define QPID_SYS_SYSTEM_INFO_H 1
 ...
 */
QPID_SYS_EXTERN long concurrency();
 ...
 */
QPID_SYS_EXTERN bool getLocalHostname (Address &address);
 ...
 */
QPID_SYS_EXTERN void getInterfaceNames(std::vector<std::string>& names );
 ...
 */
QPID_SYS_EXTERN bool getInterfaceAddresses(const std::string& interface, std::vector<std::string>& addresses);
 ...
 */
QPID_SYS_EXTERN void getSystemId (std::string &osName,
                                     std::string &nodeName,
                                     std::string &release,
                                     std::string &version,
                                     std::string &machine);
