#ifndef QPID_SYS_POLLABLE_CONDITION_H
#define QPID_SYS_POLLABLE_CONDITION_H 1
...
public:
    ...
    QPID_SYS_EXTERN PollableCondition(const Callback& cb,
                      const boost::shared_ptr<sys::Poller>& poller);

	QPID_SYS_EXTERN ~PollableCondition();

    /**
     * Set the condition. Triggers callback to Callback from Poller.
     */
	QPID_SYS_EXTERN void set();
...
#endif  /*!QPID_SYS_POLLABLE_CONDITION_H*/
