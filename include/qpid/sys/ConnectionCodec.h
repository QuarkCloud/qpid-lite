...
#define QPID_SYS_CONNECTION_CODEC_H 1
...
#include "qpid/sys/ProtocolVersion.h"
  ...
  public:
    ...
    struct Factory {
        ...
        virtual ConnectionCodec* create(
            const ProtocolVersion&, OutputControl&, const std::string& id,
        ...
        virtual ProtocolVersion supportedVersion() const = 0;
    };
};
