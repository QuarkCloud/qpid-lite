#ifndef QPID_AMQP1_0_ADDRESS_HELPER_H
#define QPID_AMQP1_0_ADDRESS_HELPER_H 1
...
namespace qpid {
	namespace amqp1_0 {
		...
		public:
			...
			AddressHelper(const amqp::Address& address);
			...
			static std::string getLinkName(const amqp::Address& address);
		private:
			struct Filter
			{
				std::string name;
...
#endif  /*!QPID_AMQP1_0_ADDRESS_HELPER_H*/
