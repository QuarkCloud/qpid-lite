#ifndef QPID_AMQP1_0_RECEIVER_CONTEXT_H
#define QPID_AMQP1_0_RECEIVER_CONTEXT_H 1
...
namespace qpid {
	namespace amqp1_0 {
		...
		{
		public:
			ReceiverContext(pn_session_t* session, const std::string& name, const qpid::amqp::Address& source);
...
#endif  /*!QPID_AMQP1_0_RECEIVER_CONTEXT_H*/
