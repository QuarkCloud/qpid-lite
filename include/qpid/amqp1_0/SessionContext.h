#ifndef QPID_AMQP1_0_SESSION_CONTEXT_H
#define QPID_AMQP1_0_SESSION_CONTEXT_H 1
...
namespace qpid {
	namespace amqp1_0 {
		...
		public:
			...
			boost::shared_ptr<SenderContext> createSender(const qpid::amqp::Address& address, const SenderOptions&);
			boost::shared_ptr<ReceiverContext> createReceiver(const qpid::amqp::Address& address);
...
#endif  /*!QPID_AMQP1_0_SESSION_CONTEXT_H*/
