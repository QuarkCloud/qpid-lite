#ifndef QPID_MESSAGING_COMPILE_H
#define QPID_MESSAGING_COMPILE_H 1
...
#if defined(MESSAGING_EXPORT) || defined (qpidmessaging_EXPORTS)
...
#endif  /*!QPID_MESSAGING_COMPILE_H*/
