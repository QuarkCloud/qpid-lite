#ifndef QPID_MESSAGING_AMQP_MESSAGE_READER_H
#define QPID_MESSAGING_AMQP_MESSAGE_READER_H 1
...
namespace qpid {
	namespace messaging {
		namespace amqp {
			...
			{
			public:
				QPID_MESSAGING_EXTERN MessageReader();

				//header, properties, amqp-sequence, amqp-value
				QPID_MESSAGING_EXTERN bool onStartList(uint32_t, const CharSequence&, const CharSequence&, const Descriptor*);
				QPID_MESSAGING_EXTERN void onEndList(uint32_t, const Descriptor*);

				//delivery-annotations, message-annotations, application-headers, amqp-value
				QPID_MESSAGING_EXTERN bool onStartMap(uint32_t, const CharSequence&, const CharSequence&, const Descriptor*);
				QPID_MESSAGING_EXTERN void onEndMap(uint32_t, const Descriptor*);
				...
				QPID_MESSAGING_EXTERN bool onStartArray(uint32_t, const CharSequence&, const Constructor&, const Descriptor*);
				QPID_MESSAGING_EXTERN void onEndArray(uint32_t, const Descriptor*);
				QPID_MESSAGING_EXTERN void onDescriptor(const Descriptor&, const char*);
				...
				QPID_MESSAGING_EXTERN CharSequence getBareMessage() const;
...
#endif  /*!QPID_MESSAGING_AMQP_MESSAGE_READER_H*/
