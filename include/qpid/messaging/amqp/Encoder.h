#ifndef QPID_MESSAING_AMQP_ENCODER_H
#define QPID_MESSAING_AMQP_ENCODER_H 1
...
#include "qpid/messaging/amqp/Constructor.h"
...
namespace messaging {
	namespace amqp {
		...
		public:
			 ...
			 */
			QPID_MESSAGING_EXTERN Encoder(char* data, size_t size);
			...
			QPID_MESSAGING_EXTERN void writeBinary(const std::string&, const Descriptor* d = 0);
			...
			QPID_MESSAGING_EXTERN void writeValue(const qpid::types::Variant&, const Descriptor* d = 0);
			QPID_MESSAGING_EXTERN void writeMap(const std::map<std::string, qpid::types::Variant>& value, const Descriptor* d = 0, bool large = true);
			QPID_MESSAGING_EXTERN void writeList(const std::list<qpid::types::Variant>& value, const Descriptor* d = 0, bool large = true);

			void writeDescriptor(const Descriptor&);
			QPID_MESSAGING_EXTERN size_t getPosition();
...
#endif  /*!QPID_MESSAING_AMQP_ENCODER_H*/
