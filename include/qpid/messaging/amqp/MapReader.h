#ifndef QPID_MESSAGING_AMQP_MAP_READER_H
#define QPID_MESSAGING_AMQP_MAP_READER_H 1
	...
	namespace messaging {
		namespace amqp {
			...
			public:
				...
				QPID_MESSAGING_EXTERN MapReader();
				QPID_MESSAGING_EXTERN static const int SYMBOL_KEY;
				QPID_MESSAGING_EXTERN static const int STRING_KEY;
				QPID_MESSAGING_EXTERN void setAllowedKeyType(int);
			private:
				CharSequence key;
				size_t level;
				int keyType;
...
#endif  /*!QPID_MESSAGING_AMQP_MAP_READER_H*/
