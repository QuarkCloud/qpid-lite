#ifndef QPID_DRIVER_SUBSCRIPTION_MANAGER_IMPL_H
#define QPID_DRIVER_SUBSCRIPTION_MANAGER_IMPL_H 1
 ...
 * 
 */
class SubscriptionManagerImpl : public sys::Runnable, public sys::RefCounted
{
  public:
  ...
  private:
    ...
    qpid::driver::Dispatcher dispatcher;
...
#endif  /*!QPID_DRIVER_SUBSCRIPTION_MANAGER_IMPL_H*/
