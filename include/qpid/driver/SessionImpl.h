#ifndef QPID_DRIVER_SESSION_IMPL_H
#define QPID_DRIVER_SESSION_IMPL_H 1
...
#include "qpid/driver/Execution.h"
#include "qpid/driver/Results.h"
...
public:
    ...
    QPID_DRIVER_EXTERN void assertOpen() const;
    QPID_DRIVER_EXTERN bool hasError() const;

    Future send(const framing::AMQBody& command);
    Future send(const framing::AMQBody& command, const framing::MethodContent& content);
    QPID_DRIVER_EXTERN Future send(const framing::AMQBody& command, const framing::FrameSet& content);
    ...
    QPID_DRIVER_EXTERN void setException(const sys::ExceptionHolder&);
...
#endif  /**QPID_DRIVER_SESSION_IMPL_H*/
