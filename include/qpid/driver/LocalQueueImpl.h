#ifndef QPID_DRIVER_LOCAL_QUEUE_IMPL_H
#define QPID_DRIVER_LOCAL_QUEUE_IMPL_H 1
...
class LocalQueueImpl : public sys::RefCounted {
  public:
...
#endif  /*!QPID_DRIVER_LOCAL_QUEUE_IMPL_H*/
