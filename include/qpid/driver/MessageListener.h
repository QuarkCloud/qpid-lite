#ifndef QPID_DRIVER_MESSAGE_LISTENER_H
#define QPID_DRIVER_MESSAGE_LISTENER_H 1
...
namespace driver {
    ...
    class QPID_DRIVER_CLASS_EXTERN MessageListener{
    public:
        QPID_DRIVER_EXTERN virtual ~MessageListener();
...
#endif  /**QPID_DRIVER_MESSAGE_LISTENER_H*/
