...
class QPID_CLIENT_CLASS_EXTERN Connection
{
  ...
  public:
     ...
     * within a single broker).
     */
    QPID_CLIENT_EXTERN void open(const sys::Url& url,
              const std::string& uid = "",
              const std::string& pwd = "",
              const std::string& virtualhost = "/", uint16_t maxFrameSize=65535);
     ...
     */
    QPID_CLIENT_EXTERN void open(const sys::Url& url, const amqp::ConnectionOptions& settings);
     ...
     */
    QPID_CLIENT_EXTERN void open(const amqp::ConnectionOptions& settings);
     ...
     */
    QPID_CLIENT_EXTERN std::vector<sys::Url> getInitialBrokers();
     ...
     */
    QPID_CLIENT_EXTERN const amqp::ConnectionOptions& getNegotiatedSettings() const;
