#ifndef QPID_CLIENT_FAILOVER_LISTENER_H
#define QPID_CLIENT_FAILOVER_LISTENER_H 1
...
class QPID_CLIENT_CLASS_EXTERN FailoverListener : private MessageListener, private qpid::sys::Runnable 
{
  public:
    ...
    static QPID_CLIENT_EXTERN std::vector<sys::Url> getKnownBrokers(const Message& m);
    ...
    */
    ...
    QPID_CLIENT_EXTERN std::vector<sys::Url> getKnownBrokers() const;
...
#endif  /*!QPID_CLIENT_FAILOVER_LISTENER_H*/
