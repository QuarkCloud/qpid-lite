#ifndef QPID_CLIENT_ASYNCSESSION0_10_H
#define QPID_CLIENT_ASYNCSESSION0_10_H
/*
 *
...
#include "qpid/client/no_keyword/AsyncSession0_10.h"
 ...
 * This class provides the same set of functions as no_keyword::AsyncSession0_10, but also
 ...
 * to read. You may find it easier to read the documentation for no_keyword::AsyncSession0_10
 ...
 * 
 */
class AsyncSession0_10:
    public no_keyword::AsyncSession0_10
{
  public:
    
    QPID_CLIENT_EXTERN AsyncSession0_10();
    QPID_CLIENT_INLINE_EXTERN AsyncSession0_10(const SessionBase0_10& other);
    QPID_CLIENT_INLINE_EXTERN AsyncSession0_10& operator=(const SessionBase0_10& other);
  private:
  ...
  public:
    BOOST_PARAMETER_MEMFUN(Completion, executionSync, 0, 1, ExecutionSyncParameters) {
        return no_keyword::AsyncSession0_10::executionSync(
            p[arg::sync|false]);
    }
    
    BOOST_PARAMETER_MEMFUN(Completion, executionResult, 0, 3, ExecutionResultParameters) {
        return no_keyword::AsyncSession0_10::executionResult(
    ...
    BOOST_PARAMETER_MEMFUN(Completion, executionException, 0, 8, ExecutionExceptionParameters) {
        return no_keyword::AsyncSession0_10::executionException(
            p[arg::errorCode|0],
            p[arg::commandId|SequenceNumber()],
            p[arg::classCode|0],
            p[arg::commandCode|0],
    ...
    BOOST_PARAMETER_MEMFUN(Completion, messageTransfer, 0, 5, MessageTransferParameters) {
        return no_keyword::AsyncSession0_10::messageTransfer(
    ...
    BOOST_PARAMETER_MEMFUN(Completion, messageRelease, 0, 3, MessageReleaseParameters) {
        return no_keyword::AsyncSession0_10::messageRelease(
            p[arg::transfers|SequenceSet()],
    ...
    BOOST_PARAMETER_MEMFUN(Completion, messageSubscribe, 0, 9, MessageSubscribeParameters) {
        return no_keyword::AsyncSession0_10::messageSubscribe(
    ...
    BOOST_PARAMETER_MEMFUN(Completion, messageCancel, 0, 2, MessageCancelParameters) {
        return no_keyword::AsyncSession0_10::messageCancel(
            p[arg::destination|std::string()],
            p[arg::sync|false]);
    }
    
    BOOST_PARAMETER_MEMFUN(Completion, messageSetFlowMode, 0, 3, MessageSetFlowModeParameters) {
        return no_keyword::AsyncSession0_10::messageSetFlowMode(
            p[arg::destination|std::string()],
            p[arg::flowMode|0],
            p[arg::sync|false]);
    }
    ...
    BOOST_PARAMETER_MEMFUN(Completion, messageFlow, 0, 4, MessageFlowParameters) {
        return no_keyword::AsyncSession0_10::messageFlow(
            p[arg::destination|std::string()],
            p[arg::unit|0],
            p[arg::value|0],
            p[arg::sync|false]);
    ...
    BOOST_PARAMETER_MEMFUN(TypedResult<qpid::framing::XaResult>, dtxEnd, 0, 4, DtxEndParameters) {
        return no_keyword::AsyncSession0_10::dtxEnd(
            p[arg::xid|Xid()],
            p[arg::fail|false],
            p[arg::suspend|false],
            p[arg::sync|false]);
    ...
    BOOST_PARAMETER_MEMFUN(TypedResult<qpid::framing::XaResult>, dtxCommit, 0, 3, DtxCommitParameters) {
        return no_keyword::AsyncSession0_10::dtxCommit(
            p[arg::xid|Xid()],
    ...
    BOOST_PARAMETER_MEMFUN(Completion, exchangeDeclare, 0, 8, ExchangeDeclareParameters) {
        return no_keyword::AsyncSession0_10::exchangeDeclare(
    ...
    BOOST_PARAMETER_MEMFUN(Completion, exchangeDelete, 0, 3, ExchangeDeleteParameters) {
        return no_keyword::AsyncSession0_10::exchangeDelete(
            p[arg::exchange|std::string()],
    ...
    BOOST_PARAMETER_MEMFUN(TypedResult<qpid::framing::ExchangeQueryResult>, exchangeQuery, 0, 2, ExchangeQueryParameters) {
        return no_keyword::AsyncSession0_10::exchangeQuery(
            p[arg::name|std::string()],
            p[arg::sync|false]);
    }
    
    BOOST_PARAMETER_MEMFUN(Completion, exchangeBind, 0, 5, ExchangeBindParameters) {
        return no_keyword::AsyncSession0_10::exchangeBind(
            p[arg::queue|std::string()],
            p[arg::exchange|std::string()],
    ...
    BOOST_PARAMETER_MEMFUN(Completion, exchangeUnbind, 0, 4, ExchangeUnbindParameters) {
        return no_keyword::AsyncSession0_10::exchangeUnbind(
            p[arg::queue|std::string()],
            p[arg::exchange|std::string()],
            p[arg::bindingKey|std::string()],
            p[arg::sync|false]);
    ...
    BOOST_PARAMETER_MEMFUN(TypedResult<qpid::framing::ExchangeBoundResult>, exchangeBound, 0, 5, ExchangeBoundParameters) {
        return no_keyword::AsyncSession0_10::exchangeBound(
            p[arg::exchange|std::string()],
            p[arg::queue|std::string()],
            p[arg::bindingKey|std::string()],
            p[arg::arguments|FieldTable()],
    ...
    BOOST_PARAMETER_MEMFUN(Completion, queueDeclare, 0, 8, QueueDeclareParameters) {
        return no_keyword::AsyncSession0_10::queueDeclare(
            p[arg::queue|std::string()],
            p[arg::alternateExchange|std::string()],
            p[arg::passive|false],
            p[arg::durable|false],
    ...
    BOOST_PARAMETER_MEMFUN(Completion, queueDelete, 0, 4, QueueDeleteParameters) {
        return no_keyword::AsyncSession0_10::queueDelete(
            p[arg::queue|std::string()],
            p[arg::ifUnused|false],
            p[arg::ifEmpty|false],
            p[arg::sync|false]);
...
inline AsyncSession0_10::AsyncSession0_10() {}
inline AsyncSession0_10::AsyncSession0_10(const SessionBase0_10& other) {
    *this = other;
}
inline AsyncSession0_10& AsyncSession0_10::operator=(const SessionBase0_10& other) {
...
#endif  /*!QPID_CLIENT_ASYNCSESSION0_10_H*/
