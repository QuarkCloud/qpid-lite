#ifndef QPID_FRAMING_FILE_STAGE_BODY_H
#define QPID_FRAMING_FILE_STAGE_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileStageBody : public ModelMethod {
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_FILE_STAGE_BODY_H*/
