#ifndef QPID_FRAMING_STREAM_PUBLISH_BODY_H
#define QPID_FRAMING_STREAM_PUBLISH_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN StreamPublishBody : public ModelMethod {
    std::string exchange;
...
#endif  /*!QPID_FRAMING_STREAM_PUBLISH_BODY_H*/
