#ifndef QPID_FRAMING_CONNECTION_REDIRECT_BODY_H
#define QPID_FRAMING_CONNECTION_REDIRECT_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ConnectionRedirectBody : public AMQMethodBody {
    std::string host;
    Array knownHosts;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setHost(const std::string& _host);
    QPID_FRAMING_EXTERN const std::string& getHost() const;
    QPID_FRAMING_EXTERN bool hasHost() const;
    QPID_FRAMING_EXTERN void clearHostFlag();
    QPID_FRAMING_EXTERN void setKnownHosts(const Array& _knownHosts);
    QPID_FRAMING_EXTERN const Array& getKnownHosts() const;
    QPID_FRAMING_EXTERN bool hasKnownHosts() const;
    QPID_FRAMING_EXTERN void clearKnownHostsFlag();
...
#endif  /*!QPID_FRAMING_CONNECTION_REDIRECT_BODY_H*/
