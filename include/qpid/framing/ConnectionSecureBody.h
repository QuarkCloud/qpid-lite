#ifndef QPID_FRAMING_CONNECTION_SECURE_BODY_H
#define QPID_FRAMING_CONNECTION_SECURE_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ConnectionSecureBody : public AMQMethodBody {
...
public:
    ...
    QPID_FRAMING_EXTERN void setChallenge(const std::string& _challenge);
    QPID_FRAMING_EXTERN const std::string& getChallenge() const;
    QPID_FRAMING_EXTERN bool hasChallenge() const;
    QPID_FRAMING_EXTERN void clearChallengeFlag();
...
#endif  /*!QPID_FRAMING_CONNECTION_SECURE_BODY_H*/
