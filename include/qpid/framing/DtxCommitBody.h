#ifndef QPID_FRAMING_DTX_COMMIT_BODY_H
#define QPID_FRAMING_DTX_COMMIT_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN DtxCommitBody : public ModelMethod {
    Xid xid;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setOnePhase(bool _onePhase);
    QPID_FRAMING_EXTERN bool getOnePhase() const;
...
#endif  /*!QPID_FRAMING_DTX_COMMIT_BODY_H*/
