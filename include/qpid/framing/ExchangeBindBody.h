#ifndef QPID_FRAMING_EXCHANGE_BIND_BODY_H
#define QPID_FRAMING_EXCHANGE_BIND_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ExchangeBindBody : public ModelMethod {
    std::string queue;
    std::string exchange;
...
#endif  /*!QPID_FRAMING_EXCHANGE_BIND_BODY_H*/
