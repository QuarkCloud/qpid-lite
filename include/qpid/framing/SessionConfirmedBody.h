#ifndef QPID_FRAMING_SESSION_CONFIRMED_BODY_H
#define QPID_FRAMING_SESSION_CONFIRMED_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN SessionConfirmedBody : public AMQMethodBody {
...
public:
    ...
    QPID_FRAMING_EXTERN void setCommands(const SequenceSet& _commands);
    QPID_FRAMING_EXTERN const SequenceSet& getCommands() const;
    QPID_FRAMING_EXTERN bool hasCommands() const;
    QPID_FRAMING_EXTERN void clearCommandsFlag();
    QPID_FRAMING_EXTERN void setFragments(const Array& _fragments);
    QPID_FRAMING_EXTERN const Array& getFragments() const;
    QPID_FRAMING_EXTERN bool hasFragments() const;
    QPID_FRAMING_EXTERN void clearFragmentsFlag();
...
#endif  /*!QPID_FRAMING_SESSION_CONFIRMED_BODY_H*/
