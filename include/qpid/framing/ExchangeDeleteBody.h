#ifndef QPID_FRAMING_EXCHANGE_DELETE_BODY_H
#define QPID_FRAMING_EXCHANGE_DELETE_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ExchangeDeleteBody : public ModelMethod {
    std::string exchange;
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_EXCHANGE_DELETE_BODY_H*/
