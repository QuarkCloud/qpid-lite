#ifndef QPID_FRAMING_REPLY_TO_H
#define QPID_FRAMING_REPLY_TO_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ReplyTo  {
    std::string exchange;
...
public:
    ...
    QPID_FRAMING_EXTERN friend std::ostream& operator<<(std::ostream&, const ReplyTo&);
