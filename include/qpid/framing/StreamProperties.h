#ifndef QPID_FRAMING_STREAM_PROPERTIES_H
#define QPID_FRAMING_STREAM_PROPERTIES_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN StreamProperties  {
...
public:
    ...
    QPID_FRAMING_EXTERN friend std::ostream& operator<<(std::ostream&, const StreamProperties&);
...
#endif  /*!QPID_FRAMING_STREAM_PROPERTIES_H*/
