#ifndef QPID_FRAMING_DTX_GET_TIMEOUT_RESULT_H
#define QPID_FRAMING_DTX_GET_TIMEOUT_RESULT_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN DtxGetTimeoutResult  {
    uint32_t timeout;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN friend std::ostream& operator<<(std::ostream&, const DtxGetTimeoutResult&);
...
#endif  /*!QPID_FRAMING_DTX_GET_TIMEOUT_RESULT_H*/
