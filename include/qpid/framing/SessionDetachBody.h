#ifndef QPID_FRAMING_SESSION_DETACH_BODY_H
#define QPID_FRAMING_SESSION_DETACH_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN SessionDetachBody : public AMQMethodBody {
    std::string name;
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_SESSION_DETACH_BODY_H*/
