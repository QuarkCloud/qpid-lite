#ifndef QPID_FRAMING_CONNECTION_SECURE_OK_BODY_H
#define QPID_FRAMING_CONNECTION_SECURE_OK_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ConnectionSecureOkBody : public AMQMethodBody {
    std::string response;
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_CONNECTION_SECURE_OK_BODY_H*/
