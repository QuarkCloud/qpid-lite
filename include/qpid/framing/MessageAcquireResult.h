#ifndef QPID_FRAMING_MESSAGE_ACQUIRE_RESULT_H
#define QPID_FRAMING_MESSAGE_ACQUIRE_RESULT_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN MessageAcquireResult  {
...
public:
    ...
    QPID_FRAMING_EXTERN friend std::ostream& operator<<(std::ostream&, const MessageAcquireResult&);
...
#endif  /*!QPID_FRAMING_MESSAGE_ACQUIRE_RESULT_H*/
