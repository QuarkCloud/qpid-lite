#ifndef QPID_FRAMING_SESSION_DETACHED_BODY_H
#define QPID_FRAMING_SESSION_DETACHED_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN SessionDetachedBody : public AMQMethodBody {
    std::string name;
    uint8_t code;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setName(const std::string& _name);
    QPID_FRAMING_EXTERN const std::string& getName() const;
    QPID_FRAMING_EXTERN bool hasName() const;
    QPID_FRAMING_EXTERN void clearNameFlag();
    QPID_FRAMING_EXTERN void setCode(uint8_t _code);
    QPID_FRAMING_EXTERN uint8_t getCode() const;
...
#endif  /*!QPID_FRAMING_SESSION_DETACHED_BODY_H*/
