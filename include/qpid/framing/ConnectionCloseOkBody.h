#ifndef QPID_FRAMING_CONNECTION_CLOSE_OK_BODY_H
#define QPID_FRAMING_CONNECTION_CLOSE_OK_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ConnectionCloseOkBody : public AMQMethodBody {
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_CONNECTION_CLOSE_OK_BODY_H*/
