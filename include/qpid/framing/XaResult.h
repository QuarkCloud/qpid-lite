#ifndef QPID_FRAMING_XA_RESULT_H
#define QPID_FRAMING_XA_RESULT_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN XaResult  {
    uint16_t status;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setStatus(uint16_t _status);
    QPID_FRAMING_EXTERN uint16_t getStatus() const;
    QPID_FRAMING_EXTERN bool hasStatus() const;
    QPID_FRAMING_EXTERN void clearStatusFlag();
    QPID_FRAMING_EXTERN friend std::ostream& operator<<(std::ostream&, const XaResult&);
...
#endif  /*!QPID_FRAMING_XA_RESULT_H*/
