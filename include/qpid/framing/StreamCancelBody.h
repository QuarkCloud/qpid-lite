#ifndef QPID_FRAMING_STREAM_CANCEL_BODY_H
#define QPID_FRAMING_STREAM_CANCEL_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN StreamCancelBody : public ModelMethod {
...
#endif  /*!QPID_FRAMING_STREAM_CANCEL_BODY_H*/
