#ifndef QPID_FRAMING_FILE_RETURN_BODY_H
#define QPID_FRAMING_FILE_RETURN_BODY_H
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileReturnBody : public ModelMethod {
    uint16_t replyCode;
...
#endif  /*!QPID_FRAMING_FILE_RETURN_BODY_H*/
