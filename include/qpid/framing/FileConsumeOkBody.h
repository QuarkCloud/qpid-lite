#ifndef QPID_FRAMING_FILE_CONSUME_OK_BODY_H
#define QPID_FRAMING_FILE_CONSUME_OK_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileConsumeOkBody : public ModelMethod {
...
#endif  /*!QPID_FRAMING_FILE_CONSUME_OK_BODY_H*/
