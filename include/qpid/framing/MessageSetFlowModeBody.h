#ifndef QPID_FRAMING_MESSAGE_SET_FLOW_MODE_BODY_H
#define QPID_FRAMING_MESSAGE_SET_FLOW_MODE_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN MessageSetFlowModeBody : public ModelMethod {
...
public:
    ...
    QPID_FRAMING_EXTERN void setFlowMode(uint8_t _flowMode);
    QPID_FRAMING_EXTERN uint8_t getFlowMode() const;
    QPID_FRAMING_EXTERN bool hasFlowMode() const;
    QPID_FRAMING_EXTERN void clearFlowModeFlag();
...
#endif  /*!QPID_FRAMING_MESSAGE_SET_FLOW_MODE_BODY_H*/
