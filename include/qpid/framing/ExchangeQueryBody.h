#ifndef QPID_FRAMING_EXCHANGE_QUERY_BODY_H
#define QPID_FRAMING_EXCHANGE_QUERY_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ExchangeQueryBody : public ModelMethod {
    std::string name;
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_EXCHANGE_QUERY_BODY_H*/
