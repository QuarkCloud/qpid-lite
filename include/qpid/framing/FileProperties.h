#ifndef QPID_FRAMING_FILE_PROPERTIES_H
#define QPID_FRAMING_FILE_PROPERTIES_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileProperties  {
...
public:
    ...
    QPID_FRAMING_EXTERN void setHeaders(const FieldTable& _headers);
    QPID_FRAMING_EXTERN const FieldTable& getHeaders() const;
    QPID_FRAMING_EXTERN FieldTable& getHeaders();
    QPID_FRAMING_EXTERN bool hasHeaders() const;
    QPID_FRAMING_EXTERN void clearHeadersFlag();
    ...
    QPID_FRAMING_EXTERN void setReplyTo(const std::string& _replyTo);
    QPID_FRAMING_EXTERN const std::string& getReplyTo() const;
    QPID_FRAMING_EXTERN bool hasReplyTo() const;
    QPID_FRAMING_EXTERN void clearReplyToFlag();
    QPID_FRAMING_EXTERN void setMessageId(const std::string& _messageId);
    QPID_FRAMING_EXTERN const std::string& getMessageId() const;
    QPID_FRAMING_EXTERN bool hasMessageId() const;
    QPID_FRAMING_EXTERN void clearMessageIdFlag();
    QPID_FRAMING_EXTERN void setFilename(const std::string& _filename);
    QPID_FRAMING_EXTERN const std::string& getFilename() const;
    QPID_FRAMING_EXTERN bool hasFilename() const;
    QPID_FRAMING_EXTERN void clearFilenameFlag();
    ...
    QPID_FRAMING_EXTERN void setClusterId(const std::string& _clusterId);
    QPID_FRAMING_EXTERN const std::string& getClusterId() const;
    QPID_FRAMING_EXTERN bool hasClusterId() const;
    QPID_FRAMING_EXTERN void clearClusterIdFlag();
    QPID_FRAMING_EXTERN friend std::ostream& operator<<(std::ostream&, const FileProperties&);
...
#endif  /*!QPID_FRAMING_FILE_PROPERTIES_H*/
