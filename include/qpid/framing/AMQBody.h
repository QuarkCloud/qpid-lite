#ifndef QPID_FRAMING_AMQ_BODY_H
#define QPID_FRAMING_AMQ_BODY_H 1
...
class QPID_FRAMING_CLASS_EXTERN AMQBody : public sys::RefCounted {
  public:
    AMQBody() {}
    QPID_FRAMING_EXTERN virtual ~AMQBody();

    // Make AMQBody copyable even though RefCounted. 
    AMQBody(const AMQBody&) : sys::RefCounted() {}
...
QPID_FRAMING_EXTERN std::ostream& operator<<(std::ostream& out, const AMQBody& body) ;
