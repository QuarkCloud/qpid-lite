#ifndef QPID_FRAMING_SESSION_GAP_BODY_H
#define QPID_FRAMING_SESSION_GAP_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN SessionGapBody : public AMQMethodBody {
...
#endif  /*!QPID_FRAMING_SESSION_GAP_BODY_H*/
