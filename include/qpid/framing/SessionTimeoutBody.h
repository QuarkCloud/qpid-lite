#ifndef QPID_FRAMING_SESSION_TIMEOUT_BODY_H
#define QPID_FRAMING_SESSION_TIMEOUT_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN SessionTimeoutBody : public AMQMethodBody {
    uint32_t timeout;
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_SESSION_TIMEOUT_BODY_H*/
