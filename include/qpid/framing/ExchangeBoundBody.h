#ifndef QPID_FRAMING_EXCHANGE_BOUND_BODY_H
#define QPID_FRAMING_EXCHANGE_BOUND_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ExchangeBoundBody : public ModelMethod {
    std::string exchange;
    std::string queue;
...
#endif  /*!QPID_FRAMING_EXCHANGE_BOUND_BODY_H*/
