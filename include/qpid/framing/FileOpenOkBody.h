#ifndef QPID_FRAMING_FILE_OPEN_OK_BODY_H
#define QPID_FRAMING_FILE_OPEN_OK_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileOpenOkBody : public ModelMethod {
    uint64_t stagedSize;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setStagedSize(uint64_t _stagedSize);
    QPID_FRAMING_EXTERN uint64_t getStagedSize() const;
    QPID_FRAMING_EXTERN bool hasStagedSize() const;
    QPID_FRAMING_EXTERN void clearStagedSizeFlag();
...
#endif  /*!QPID_FRAMING_FILE_OPEN_OK_BODY_H*/
