#ifndef QPID_FRAMING_MESSAGE_SUBSCRIBE_BODY_H
#define QPID_FRAMING_MESSAGE_SUBSCRIBE_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN MessageSubscribeBody : public ModelMethod {
    std::string queue;
...
#endif  /*!QPID_FRAMING_MESSAGE_SUBSCRIBE_BODY_H*/
