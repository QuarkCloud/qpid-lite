#ifndef QPID_FRAMING_DTX_START_BODY_H
#define QPID_FRAMING_DTX_START_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN DtxStartBody : public ModelMethod {
    Xid xid;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setJoin(bool _join);
    QPID_FRAMING_EXTERN bool getJoin() const;
    QPID_FRAMING_EXTERN void setResume(bool _resume);
    QPID_FRAMING_EXTERN bool getResume() const;
...
#endif  /*!QPID_FRAMING_DTX_START_BODY_H*/
