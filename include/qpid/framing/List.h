 ...
 */
class QPID_FRAMING_CLASS_EXTERN List
{
  public:
    ...
    QPID_FRAMING_EXTERN bool operator==(const List& other) const;
    ...
    QPID_FRAMING_INLINE_EXTERN iterator insert(iterator i, ValuePtr value) { return values.insert(i, value); }
  ...
  private:
    ...
    friend QPID_FRAMING_EXTERN std::ostream& operator<<(std::ostream& out, const List& list);
};
