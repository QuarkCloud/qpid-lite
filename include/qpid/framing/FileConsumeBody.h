#ifndef QPID_FRAMING_FILE_CONSUME_BODY_H
#define QPID_FRAMING_FILE_CONSUME_BODY_H
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileConsumeBody : public ModelMethod {
    std::string queue;
...
public:
    ...
    QPID_FRAMING_EXTERN void setConsumerTag(const std::string& _consumerTag);
    QPID_FRAMING_EXTERN const std::string& getConsumerTag() const;
    QPID_FRAMING_EXTERN bool hasConsumerTag() const;
    QPID_FRAMING_EXTERN void clearConsumerTagFlag();
    QPID_FRAMING_EXTERN void setNoLocal(bool _noLocal);
    QPID_FRAMING_EXTERN bool getNoLocal() const;
    QPID_FRAMING_EXTERN void setNoAck(bool _noAck);
    QPID_FRAMING_EXTERN bool getNoAck() const;
    QPID_FRAMING_EXTERN void setExclusive(bool _exclusive);
    QPID_FRAMING_EXTERN bool getExclusive() const;
    QPID_FRAMING_EXTERN void setNowait(bool _nowait);
    QPID_FRAMING_EXTERN bool getNowait() const;
...
#endif  /*!QPID_FRAMING_FILE_CONSUME_BODY_H*/
