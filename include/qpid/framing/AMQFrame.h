#ifndef QPID_FRAMING_AMQ_FRAME_H
#define QPID_FRAMING_AMQ_FRAME_H 1
...
class QPID_FRAMING_CLASS_EXTERN AMQFrame : public AMQDataBlock
{
  public:
    QPID_FRAMING_EXTERN AMQFrame(const boost::intrusive_ptr<AMQBody>& b=0);
    QPID_FRAMING_EXTERN AMQFrame(const AMQBody& b);
    QPID_FRAMING_EXTERN ~AMQFrame();
     ...
     */
    QPID_FRAMING_EXTERN void cloneBody();

    QPID_FRAMING_EXTERN void encode(Buffer& buffer) const; 
    QPID_FRAMING_EXTERN bool decode(Buffer& buffer); 
    ...
    QPID_FRAMING_EXTERN static uint32_t frameOverhead();
...
QPID_FRAMING_EXTERN std::ostream& operator<<(std::ostream&, const AMQFrame&);

}} // namespace qpid::framing


#endif /** QPID_FRAMING_AMQ_FRAME_H */
