#ifndef QPID_FRAMING_CONNECTION_OPEN_OK_BODY_H
#define QPID_FRAMING_CONNECTION_OPEN_OK_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ConnectionOpenOkBody : public AMQMethodBody {
    Array knownHosts;
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_CONNECTION_OPEN_OK_BODY_H*/
