#ifndef QPID_FRAMING_STREAM_CONSUME_BODY_H
#define QPID_FRAMING_STREAM_CONSUME_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN StreamConsumeBody : public ModelMethod {
    std::string queue;
...
#endif  /*!QPID_FRAMING_STREAM_CONSUME_BODY_H*/
