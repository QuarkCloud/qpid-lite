#ifndef QPID_FRAMING_DTX_GET_TIMEOUT_BODY_H
#define QPID_FRAMING_DTX_GET_TIMEOUT_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN DtxGetTimeoutBody : public ModelMethod {
    Xid xid;
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_DTX_GET_TIMEOUT_BODY_H*/
