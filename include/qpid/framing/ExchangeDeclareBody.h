#ifndef QPID_FRAMING_EXCHANGE_DECLARE_BODY_H
#define QPID_FRAMING_EXCHANGE_DECLARE_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ExchangeDeclareBody : public ModelMethod {
    std::string exchange;
    std::string type;
...
#endif  /*!QPID_FRAMING_EXCHANGE_DECLARE_BODY_H*/
