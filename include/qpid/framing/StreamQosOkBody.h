#ifndef QPID_FRAMING_STREAM_QOS_OK_BODY_H
#define QPID_FRAMING_STREAM_QOS_OK_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN StreamQosOkBody : public ModelMethod {
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_STREAM_QOS_OK_BODY_H*/
