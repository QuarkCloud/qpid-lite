#ifndef QPID_FRAMING_INLINE_ALLOCATOR_H
#define QPID_FRAMING_INLINE_ALLOCATOR_H 1
...
namespace qpid {
	namespace framing {
		...
		struct InlineRebind<T, T, BaseAllocator, Max> {
			typedef typename InlineAllocator<BaseAllocator, Max> other;
		};
	}
} // namespace qpid

#endif  /*!QPID_FRAMING_INLINE_ALLOCATOR_H*/
