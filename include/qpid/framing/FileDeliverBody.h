#ifndef QPID_FRAMING_FILE_DELIVER_BODY_H
#define QPID_FRAMING_FILE_DELIVER_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileDeliverBody : public ModelMethod {
...
#endif  /*!QPID_FRAMING_FILE_DELIVER_BODY_H*/
