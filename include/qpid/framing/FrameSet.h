#ifndef QPID_FRAMING_FRAME_SET_H
#define QPID_FRAMING_FRAME_SET_H 1
/*
 *
...
#include <string>
#include "qpid/framing/InlineVector.h"
...
public:
    ...
    QPID_FRAMING_EXTERN FrameSet(const SequenceNumber& id);
    QPID_FRAMING_EXTERN FrameSet(const FrameSet&);
    QPID_FRAMING_EXTERN void append(const AMQFrame& part);
    QPID_FRAMING_EXTERN bool isComplete() const;

    QPID_FRAMING_EXTERN uint64_t getContentSize() const;

    QPID_FRAMING_EXTERN void getContent(std::string&) const;
    QPID_FRAMING_EXTERN std::string getContent() const;
    QPID_FRAMING_EXTERN bool hasContent() const;

    QPID_FRAMING_EXTERN void setReceived();
    QPID_FRAMING_EXTERN bool hasExpired() const;

    bool isContentBearing() const;

    QPID_FRAMING_EXTERN const AMQMethodBody* getMethod() const;
    QPID_FRAMING_EXTERN AMQMethodBody* getMethod();
    QPID_FRAMING_EXTERN const AMQHeaderBody* getHeaders() const;
    QPID_FRAMING_EXTERN AMQHeaderBody* getHeaders();
...
#endif /*!QPID_FRAMING_FRAME_SET_H*/
