#ifndef QPID_FRAMING_FILE_OPEN_BODY_H
#define QPID_FRAMING_FILE_OPEN_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileOpenBody : public ModelMethod {
...
public:
    ...
    QPID_FRAMING_EXTERN void setContentSize(uint64_t _contentSize);
    QPID_FRAMING_EXTERN uint64_t getContentSize() const;
    QPID_FRAMING_EXTERN bool hasContentSize() const;
    QPID_FRAMING_EXTERN void clearContentSizeFlag();
...
#endif  /*!QPID_FRAMING_FILE_OPEN_BODY_H*/
