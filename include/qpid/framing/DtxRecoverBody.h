#ifndef QPID_FRAMING_DTX_RECOVER_BODY_H
#define QPID_FRAMING_DTX_RECOVER_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN DtxRecoverBody : public ModelMethod {
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_DTX_RECOVER_BODY_H*/
