#ifndef QPID_FRAMING_EXCHANGE_UNBIND_BODY_H
#define QPID_FRAMING_EXCHANGE_UNBIND_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ExchangeUnbindBody : public ModelMethod {
    std::string queue;
    std::string exchange;
...
public:
    ...
    QPID_FRAMING_EXTERN void setBindingKey(const std::string& _bindingKey);
    QPID_FRAMING_EXTERN const std::string& getBindingKey() const;
    QPID_FRAMING_EXTERN bool hasBindingKey() const;
    QPID_FRAMING_EXTERN void clearBindingKeyFlag();
...
#endif  /*!QPID_FRAMING_EXCHANGE_UNBIND_BODY_H*/
