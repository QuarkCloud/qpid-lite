#ifndef QPID_FRAMING_EXCHANGE_QUERY_RESULT_H
#define QPID_FRAMING_EXCHANGE_QUERY_RESULT_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN ExchangeQueryResult  {
    std::string type;
...
public:
    ...
    QPID_FRAMING_EXTERN void setType(const std::string& _type);
    QPID_FRAMING_EXTERN const std::string& getType() const;
    QPID_FRAMING_EXTERN bool hasType() const;
    QPID_FRAMING_EXTERN void clearTypeFlag();
    QPID_FRAMING_EXTERN void setDurable(bool _durable);
    QPID_FRAMING_EXTERN bool getDurable() const;
    QPID_FRAMING_EXTERN void setNotFound(bool _notFound);
    QPID_FRAMING_EXTERN bool getNotFound() const;
    ...
    QPID_FRAMING_EXTERN friend std::ostream& operator<<(std::ostream&, const ExchangeQueryResult&);
...
#endif  /*!QPID_FRAMING_EXCHANGE_QUERY_RESULT_H*/
