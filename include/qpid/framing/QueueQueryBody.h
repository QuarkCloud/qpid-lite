#ifndef QPID_FRAMING_QUEUE_QUERY_BODY_H
#define QPID_FRAMING_QUEUE_QUERY_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN QueueQueryBody : public ModelMethod {
    std::string queue;
    uint16_t flags;
public:
...
#endif  /*!QPID_FRAMING_QUEUE_QUERY_BODY_H*/
