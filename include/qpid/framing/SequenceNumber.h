 ...
 *
 */
#ifndef QPID_FRAMING_SEQUENCE_NUMBER_H
#define QPID_FRAMING_SEQUENCE_NUMBER_H 1
 ...
 */
class QPID_FRAMING_CLASS_EXTERN SequenceNumber : public
...
QPID_FRAMING_EXTERN std::ostream& operator<<(std::ostream& o, const SequenceNumber& n);

}} // namespace qpid::framing


#endif /**QPID_FRAMING_SEQUENCE_NUMBER_H*/
