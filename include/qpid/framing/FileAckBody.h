#ifndef QPID_FRAMING_FILE_ACK_BODY_H
#define QPID_FRAMING_FILE_ACK_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileAckBody : public ModelMethod {
...
public:
    ...
    QPID_FRAMING_EXTERN void setMultiple(bool _multiple);
    QPID_FRAMING_EXTERN bool getMultiple() const;
...
#endif  /*!QPID_FRAMING_FILE_ACK_BODY_H*/
