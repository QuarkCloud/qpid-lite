#ifndef QPID_FRAMING_MESSAGE_ACQUIRE_BODY_H
#define QPID_FRAMING_MESSAGE_ACQUIRE_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN MessageAcquireBody : public ModelMethod {
...
#endif  /*!QPID_FRAMING_MESSAGE_ACQUIRE_BODY_H*/
