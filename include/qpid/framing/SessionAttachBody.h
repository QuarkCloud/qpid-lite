#ifndef QPID_FRAMING_SESSION_ATTACH_BODY_H
#define QPID_FRAMING_SESSION_ATTACH_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN SessionAttachBody : public AMQMethodBody {
    std::string name;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setForce(bool _force);
    QPID_FRAMING_EXTERN bool getForce() const;
...
#endif  /*!QPID_FRAMING_SESSION_ATTACH_BODY_H*/
