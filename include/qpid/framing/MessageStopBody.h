#ifndef QPID_FRAMING_MESSAGE_STOP_BODY_H
#define QPID_FRAMING_MESSAGE_STOP_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN MessageStopBody : public ModelMethod {
...
#endif  /*!QPID_FRAMING_MESSAGE_STOP_BODY_H*/
