#ifndef QPID_FRAMING_MESSAGE_FLOW_BODY_H
#define QPID_FRAMING_MESSAGE_FLOW_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN MessageFlowBody : public ModelMethod {
...
public:
    ...
    QPID_FRAMING_EXTERN void setUnit(uint8_t _unit);
    QPID_FRAMING_EXTERN uint8_t getUnit() const;
    QPID_FRAMING_EXTERN bool hasUnit() const;
    QPID_FRAMING_EXTERN void clearUnitFlag();
    QPID_FRAMING_EXTERN void setValue(uint32_t _value);
    QPID_FRAMING_EXTERN uint32_t getValue() const;
...
#endif  /*!QPID_FRAMING_MESSAGE_FLOW_BODY_H*/
