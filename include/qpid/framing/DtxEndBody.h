#ifndef QPID_FRAMING_DTX_END_BODY_H
#define QPID_FRAMING_DTX_END_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN DtxEndBody : public ModelMethod {
    Xid xid;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setFail(bool _fail);
    QPID_FRAMING_EXTERN bool getFail() const;
    QPID_FRAMING_EXTERN void setSuspend(bool _suspend);
    QPID_FRAMING_EXTERN bool getSuspend() const;
...
#endif  /*!QPID_FRAMING_DTX_END_BODY_H*/
