#ifndef QPID_FRAMING_SESSION_FLUSH_BODY_H
#define QPID_FRAMING_SESSION_FLUSH_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN SessionFlushBody : public AMQMethodBody {
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setExpected(bool _expected);
    QPID_FRAMING_EXTERN bool getExpected() const;
    QPID_FRAMING_EXTERN void setConfirmed(bool _confirmed);
    QPID_FRAMING_EXTERN bool getConfirmed() const;
    QPID_FRAMING_EXTERN void setCompleted(bool _completed);
    QPID_FRAMING_EXTERN bool getCompleted() const;
...
#endif  /*!QPID_FRAMING_SESSION_FLUSH_BODY_H*/
