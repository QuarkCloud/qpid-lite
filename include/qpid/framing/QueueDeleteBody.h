#ifndef QPID_FRAMING_QUEUE_DELETE_BODY_H
#define QPID_FRAMING_QUEUE_DELETE_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN QueueDeleteBody : public ModelMethod {
    std::string queue;
    uint16_t flags;
public:
    ...
    QPID_FRAMING_EXTERN void setIfUnused(bool _ifUnused);
    QPID_FRAMING_EXTERN bool getIfUnused() const;
    QPID_FRAMING_EXTERN void setIfEmpty(bool _ifEmpty);
    QPID_FRAMING_EXTERN bool getIfEmpty() const;
...
#endif  /*!QPID_FRAMING_QUEUE_DELETE_BODY_H*/
