#ifndef QPID_FRAMING_AMQ_METHOD_BODY_H
#define QPID_FRAMING_AMQ_METHOD_BODY_H 1
...
class AMQMethodBody : public AMQBody {
  public:
    AMQMethodBody() {}
    QPID_FRAMING_EXTERN virtual ~AMQMethodBody();
...
#endif /** QPID_FRAMING_AMQ_METHOD_BODY_H */
