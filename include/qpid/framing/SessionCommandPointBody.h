#ifndef QPID_FRAMING_SESSION_COMMAND_POINT_BODY_H
#define QPID_FRAMING_SESSION_COMMAND_POINT_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN SessionCommandPointBody : public AMQMethodBody {
...
public:
    ...
    QPID_FRAMING_EXTERN void setCommandOffset(uint64_t _commandOffset);
    QPID_FRAMING_EXTERN uint64_t getCommandOffset() const;
    QPID_FRAMING_EXTERN bool hasCommandOffset() const;
    QPID_FRAMING_EXTERN void clearCommandOffsetFlag();
...
#endif  /*!QPID_FRAMING_SESSION_COMMAND_POINT_BODY_H*/
