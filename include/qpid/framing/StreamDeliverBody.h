#ifndef QPID_FRAMING_STREAM_DELIVER_BODY_H
#define QPID_FRAMING_STREAM_DELIVER_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN StreamDeliverBody : public ModelMethod {
...
#endif  /*!QPID_FRAMING_STREAM_DELIVER_BODY_H*/
