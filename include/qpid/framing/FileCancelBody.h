#ifndef QPID_FRAMING_FILE_CANCEL_BODY_H
#define QPID_FRAMING_FILE_CANCEL_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN FileCancelBody : public ModelMethod {
...
#endif  /*!QPID_FRAMING_FILE_CANCEL_BODY_H*/
