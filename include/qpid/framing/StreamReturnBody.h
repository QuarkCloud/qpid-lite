#ifndef QPID_FRAMING_STREAM_RETURN_BODY_H
#define QPID_FRAMING_STREAM_RETURN_BODY_H 1
/*
 *
...
class QPID_FRAMING_CLASS_EXTERN StreamReturnBody : public ModelMethod {
    uint16_t replyCode;
...
#endif  /*!QPID_FRAMING_STREAM_RETURN_BODY_H*/
