...
struct QPID_LOG_CLASS_EXTERN SinkOptions : public qpid::log::SinkOptions {
    QPID_LOG_EXTERN SinkOptions(const std::string& argv0);
    virtual ~SinkOptions() {}

	QPID_LOG_EXTERN virtual qpid::log::SinkOptions& operator=(const qpid::log::SinkOptions& rhs);
