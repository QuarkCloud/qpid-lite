#ifndef _QMF2_CONSOLE_SESSION_IMPL_H_
#define _QMF2_CONSOLE_SESSION_IMPL_H_ 1
/*
 *
...
#include "qmf2/SchemaCache.h"
#include "qmf2/Query.h"
...
namespace qmf2 {
    class ConsoleSessionImpl : public virtual qpid::sys::RefCounted, public qpid::sys::Runnable {
    public:
        ~ConsoleSessionImpl();
    ...
    protected:
        ...
        void handleV1SchemaResponse(qmf2::Buffer&, uint32_t, const qpid::messaging::Message&);
