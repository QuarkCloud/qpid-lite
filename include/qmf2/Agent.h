...
namespace qmf2 {
    ...
    class QMF2_CLASS_EXTERN Agent : public qmf2::Handle<AgentImpl> {
    public:
        QMF2_EXTERN Agent(AgentImpl* impl = 0);
        QMF2_EXTERN Agent(const Agent&);
        QMF2_EXTERN Agent& operator=(const Agent&);
        QMF2_EXTERN ~Agent();

        QMF2_EXTERN std::string getName() const;
        QMF2_EXTERN uint32_t getEpoch() const;
        QMF2_EXTERN std::string getVendor() const;
        QMF2_EXTERN std::string getProduct() const;
        QMF2_EXTERN std::string getInstance() const;
        QMF2_EXTERN const qpid::types::Variant& getAttribute(const std::string&) const;
        QMF2_EXTERN const qpid::types::Variant::Map& getAttributes() const;

        QMF2_EXTERN ConsoleEvent query(const Query&, qpid::messaging::Duration timeout=qpid::messaging::Duration::MINUTE);
        QMF2_EXTERN ConsoleEvent query(const std::string&, qpid::messaging::Duration timeout=qpid::messaging::Duration::MINUTE);
        QMF2_EXTERN uint32_t queryAsync(const Query&);
        QMF2_EXTERN uint32_t queryAsync(const std::string&);

        /**
         * Create a subscription to this agent
         */
        //QMF2_EXTERN Subscription subscribe(const Query&, const std::string& options = "");
        //QMF2_EXTERN Subscription subscribe(const std::string&, const std::string& options = "");

        QMF2_EXTERN ConsoleEvent callMethod(const std::string&, const qpid::types::Variant::Map&, const DataAddr&,
                                           qpid::messaging::Duration timeout=qpid::messaging::Duration::MINUTE);
        QMF2_EXTERN uint32_t callMethodAsync(const std::string&, const qpid::types::Variant::Map&, const DataAddr&);
         ...
         */
        QMF2_EXTERN ConsoleEvent querySchema(qpid::messaging::Duration timeout=qpid::messaging::Duration::MINUTE);
        QMF2_EXTERN uint32_t querySchemaAsync();
         ...
         */
        QMF2_EXTERN uint32_t getPackageCount() const;
        QMF2_EXTERN const std::string& getPackage(uint32_t) const;
         ...
         * information from the remote agent.
         */
        QMF2_EXTERN uint32_t getSchemaIdCount(const std::string&) const;
        QMF2_EXTERN SchemaId getSchemaId(const std::string&, uint32_t) const;
         ...
         */
        QMF2_EXTERN Schema getSchema(const SchemaId&, qpid::messaging::Duration timeout=qpid::messaging::Duration::MINUTE);


#ifndef SWIG
    private:
        friend class qmf2::PrivateImplRef<Agent>;
