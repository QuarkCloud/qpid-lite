#ifndef _QMF2_CONSOLE_EVENT_IMPL_H_
#define _QMF2_CONSOLE_EVENT_IMPL_H_
/*
 *
...
namespace qmf2 {
    class ConsoleEventImpl : public virtual qpid::sys::RefCounted {
    public:
        //
        // Impl-only methods
        //
