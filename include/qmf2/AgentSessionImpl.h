#ifndef __QMF2_AGENT_SESSION_IMPL_H
#define __QMF2_AGENT_SESSION_IMPL_H
...
#include "qmf2/AgentEventImpl.h"
#include "qmf2/EventNotifierImpl.h"
...
#include "qmf2/exceptions.h"
#include "qmf2/AgentSession.h"
#include "qmf2/SchemaIdImpl.h"
#include "qmf2/SchemaImpl.h"
#include "qmf2/DataAddrImpl.h"
#include "qmf2/DataImpl.h"
#include "qmf2/QueryImpl.h"
#include "qmf2/agentCapability.h"
#include "qmf2/constants.h"

#include <queue>
#include <map>

namespace qmf2 {
    typedef qmf2::PrivateImplRef<AgentSession> PI;

    class AgentSessionImpl : public virtual qpid::sys::RefCounted, public qpid::sys::Runnable {
    public:
        ~AgentSessionImpl();
    ...
    private:
        ...
        void handleV1SchemaRequest(qmf2::Buffer&, uint32_t, const qpid::messaging::Message&);
