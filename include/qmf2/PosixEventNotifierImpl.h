#ifndef __QMF2_POSIX_EVENT_NOTIFIER_IMPL_H
#define __QMF2_POSIX_EVENT_NOTIFIER_IMPL_H
...
#include "qmf2/posix/EventNotifier.h"
...
namespace qmf2
{
    ...
    class PosixEventNotifierImpl : public EventNotifierImpl, public virtual qpid::sys::RefCounted
    {
    public:
