#ifndef QMF2_CONNECTION_SETTINGS_H
#define QMF2_CONNECTION_SETTINGS_H 1
/*
 *
...
struct ConnectionSettings {
	...
	QMF2_EXTERN ConnectionSettings();
	QMF2_EXTERN virtual ~ConnectionSettings();
...
#endif /** QMF2_CONNECTION_SETTINGS_H*/
