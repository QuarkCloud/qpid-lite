...
#include "qmf2/SchemaPropertyImpl.h"
#include "qmf2/SchemaMethodImpl.h"
#include "qmf2/Hash.h"
...
Schema::Schema(const Schema& s) : qmf2::Handle<SchemaImpl>() { PI::copy(*this, s); }
...
SchemaImpl::SchemaImpl(qmf2::Buffer& buffer) : finalized(false)
{
    int schemaType;
    string packageName;
    string className;
...
#define RAW_BUF_SIZE 65536
    ...
    qmf2::Buffer buffer(rawBuf, RAW_BUF_SIZE);
