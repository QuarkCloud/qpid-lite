...
SchemaMethod::SchemaMethod(const SchemaMethod& s) : qmf2::Handle<SchemaMethodImpl>() { PI::copy(*this, s); }
...
SchemaMethodImpl::SchemaMethodImpl(qmf2::Buffer& buffer)
{
    Variant::Map::const_iterator iter;
    Variant::Map argMap;
...
void SchemaMethodImpl::encodeV1(qmf2::Buffer& buffer) const
{
    Variant::Map map;
