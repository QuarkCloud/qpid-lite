...
#include "qmf2/AgentSessionImpl.h"
...
AgentSession::AgentSession(const AgentSession& s) : qmf2::Handle<AgentSessionImpl>() { PI::copy(*this, s); }
...
void AgentSessionImpl::handleV1SchemaRequest(qmf2::Buffer& buffer, uint32_t seq, const Message& msg)
{
    string packageName;
    string className;
    uint8_t hashBits[16];
