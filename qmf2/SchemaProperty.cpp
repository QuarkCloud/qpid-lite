...
SchemaProperty::SchemaProperty(const SchemaProperty& s) : qmf2::Handle<SchemaPropertyImpl>() { PI::copy(*this, s); }
...
SchemaPropertyImpl::SchemaPropertyImpl(qmf2::Buffer& buffer) :
    access(ACCESS_READ_ONLY), index(false), optional(false), direction(DIR_IN)
{
    Variant::Map::const_iterator iter;
    Variant::Map pmap;
...
void SchemaPropertyImpl::encodeV1(qmf2::Buffer& buffer, bool isArg, bool isMethodArg) const
{
    Variant::Map pmap;
