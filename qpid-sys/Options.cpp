...
#include "qpid/sys/OptionsTemplates.h"
...
namespace qpid {
	namespace sys {
		...
		template QPID_SYS_EXTERN po::value_semantic* create_value(bool& val, const std::string& arg);
		template QPID_SYS_EXTERN po::value_semantic* create_value(int16_t& val, const std::string& arg);
		template QPID_SYS_EXTERN po::value_semantic* create_value(int32_t& val, const std::string& arg);
		template QPID_SYS_EXTERN po::value_semantic* create_value(int64_t& val, const std::string& arg);
		template QPID_SYS_EXTERN po::value_semantic* create_value(uint16_t& val, const std::string& arg);
		template QPID_SYS_EXTERN po::value_semantic* create_value(uint32_t& val, const std::string& arg);
		template QPID_SYS_EXTERN po::value_semantic* create_value(uint64_t& val, const std::string& arg);
#ifdef QPID_SIZE_T_DISTINCT
		template QPID_SYS_EXTERN po::value_semantic* create_value(size_t& val, const std::string& arg);
#endif
		template QPID_SYS_EXTERN po::value_semantic* create_value(double& val, const std::string& arg);

		template QPID_SYS_EXTERN po::value_semantic* create_value(string& val, const std::string& arg);
		template QPID_SYS_EXTERN po::value_semantic* create_value(vector<string>& val, const std::string& arg);
		template QPID_SYS_EXTERN po::value_semantic* create_value(vector<int>& val, const std::string& arg);

		template QPID_SYS_EXTERN po::value_semantic* create_value(sys::NanoDuration& val, const std::string& arg);
