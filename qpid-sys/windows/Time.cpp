...
AbsTime::AbsTime(const AbsTime& t, const NanoDuration& d) {
    if (d == NanoDuration::max()) {
...
std::istream& operator>>(std::istream& i, NanoDuration& d) {
