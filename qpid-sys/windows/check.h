#ifndef QPID_SYS_WINDOWS_CHECK_H
#define QPID_SYS_WINDOWS_CHECK_H 1
...
#define QPID_WINDOWS_ERROR(ERRVAL) qpid::sys::Exception(QPID_MSG(qpid::sys::strError(ERRVAL)))
#define QPID_WINDOWS_CRT_ERROR(ERRNO) qpid::sys::Exception(QPID_MSG(qpid::sys::strError(ERRNO)))
...
#endif  /*!QPID_SYS_WINDOWS_CHECK_H*/
