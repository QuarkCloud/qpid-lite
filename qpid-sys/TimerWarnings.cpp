...
TimerWarnings::TimerWarnings(NanoDuration reportInterval) :
    interval(reportInterval),
    nextReport(now(), reportInterval)
{}

void TimerWarnings::late(const std::string& task, NanoDuration delay) {
    taskStats[task].lateDelay.add(delay);
    log();
}

void TimerWarnings::overran(const std::string& task, NanoDuration overrun, NanoDuration time)
{
...
void TimerWarnings::lateAndOverran(
    const std::string& task, NanoDuration delay, NanoDuration overrun, NanoDuration time)
{
